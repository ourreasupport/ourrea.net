			...
			<form action="" method="post" id="form_banners" style="margin-top:30px;">
				...
				<div class="uap-delete-wrapp">
					...
					<table class="wp-list-table widefat fixed tags uap-admin-tables">
						<thead>
							<tr>
								<th style="width: 50px;"><input type="checkbox" onClick="uapSelectAllCheckboxes( this, '.uap-delete-banner' );" /></th>
								...
								<tr onmouseover="uapDhSelector('#banner_<?php echo $arr->id;?>', 1);" onmouseout="uapDhSelector('#banner_<?php echo $arr->id;?>', 0);">
									...
									<td>
										...
										<div id="banner_<?php echo $arr->id;?>" style="visibility: hidden;">
											...
											|
											<a onclick="uapDeleteFromTable(<?php echo $arr->id;?>, 'Banner', '#delete_banner_id', '#form_banners');" href="javascript:return false;" style="color: red;"><?php _e('Delete', 'uap');?></a>
										</div>
									</td>
