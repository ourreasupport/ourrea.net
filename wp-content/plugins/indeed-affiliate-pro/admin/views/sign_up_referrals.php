			<form action="" method="post">
				<div class="uap-stuffbox">
					<h3 class="uap-h3"><?php _e('SignUp Referrals (CPL - Cost Per Lead)', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/signup-referrals/" target="_blank"><?php _e('Need Help?', 'uap');?></a></span></h3>
					<div class="inside">
					<div class="row">
						<div class="col-xs-5">
							...
							<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
								...
								<input type="checkbox" class="uap-switch" onClick="uapCheckAndH(this, '#uap_sign_up_referrals_enable');" <?php echo $checked;?> />
						...
						<div class="row">
							<div class="col-xs-5">
								...
								<span class="input-group-addon" id="basic-addon1">Amount</span>
									 <input type="number" class="form-control" min="0" step='<?php echo uapInputNumerStep();?>' class="uap-input-number" value="<?php echo $data['metas']['uap_sign_up_amount_default'];?>" name="uap_sign_up_amount_default" />
								...
								<div class="input-group" style="margin-bottom:20px;">
									<span class="input-group-addon" id="basic-addon1"><?php echo $label;?></span>
										<?php $value = ($data['rank_value_array'][$id]==-1) ? '' : $data['rank_value_array'][$id];?>
								 		<input type="number" class="form-control" min="0" step='<?php echo uapInputNumerStep();?>' class="uap-input-number" value="<?php echo $value;?>" name="<?php echo "signup_ranks_value[$id]";?>" />
								 		<div class="input-group-addon"><?php echo $data['amount_types']['flat'];?></div>
									</div>
							<?php endforeach;?>
						<?php endif;?>
