			...
			<?php
				...
				foreach ($posible_types as $k=>$v):
					...
					<div class="uap-single-notf-row">
						...
						<div class="uap-single-notf-col uap-single-notf-checkbox"><input type="checkbox" onClick="uapMakeInputhString(this, '<?php echo $k;?>', '#uap_types_in')" <?php echo $checked;?> /></div>
					</div>
					<?php
				endforeach;
			?>
