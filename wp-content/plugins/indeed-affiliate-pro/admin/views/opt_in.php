<div class="uap-wrapper">
			<form action="" method="post">
				...
				<div class="uap-stuffbox">
					<h3 class="uap-h3"><?php _e('Opt-In Settings', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/how-to-activate-optin-subscriptions/" target="_blank"><?php _e('Need Help?', 'uap');?></a></span></h3>
					<div class="inside">
					...
					<div class="inside">
					    <table>
					      <tbody>
					        ...
					        <tr>
					          <td>
					            GetResponse <?php _e('List Token', 'uap');?>
					          </td>
					          <td>
					        ...
					        <tr>
					          ...
					          <td>
					            <a href="https://app.getresponse.com/campaign_list.html " target="_blank" class="uap-info-link">
					              <?php _e('Where can I find List Token?', 'uap');?>
					            </a>
					          </td>
					        </tr>
					      </tbody>
