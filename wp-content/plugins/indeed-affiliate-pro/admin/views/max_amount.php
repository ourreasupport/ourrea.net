<form action="" method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php _e('Maximum Amount', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/maximum-amount/" target="_blank"><?php _e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
		<div class="row">
		  <div class="col-xs-5">
			<div class="uap-form-line">
				...
				<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
					...
					<input type="checkbox" class="uap-switch" onClick="uapCheckAndH(this, '#uap_maximum_amount_enabled');" <?php echo $checked;?> />
				...
				<div class="row" style="margin-left:0px;">
					<div class="col-xs-5" style="margin-bottom: 10px;">
						...
						<div class="input-group" style="margin:0px 0 15px 0;">
							...
							<input type="number" min="0" step='<?php echo uapInputNumerStep();?>' class="uap-field-text-with-padding form-control" name="uap_maximum_amount_value" value="<?php echo $data['metas']['uap_maximum_amount_value'];?>" />
			...
			<?php if (!empty($data['ranks'])):?>
				...
				<?php foreach ($data['ranks'] as $rank_data):?>
								<div class="input-group" style="margin:0px 0 15px 0;">
									...
									<input type="number" min="0" step='<?php echo uapInputNumerStep();?>' class="uap-field-text-with-padding form-control" name="uap_maximum_amount_value_per_rank[<?php echo $rank_data->id;?>]" value="<?php echo $data['metas']['uap_maximum_amount_value_per_rank'][$rank_data->id];?>" />
									<div class="input-group-addon"><?php echo $data['amount_types']['flat'];?></div>
								</div>
				<?php endforeach;?>
					</div>
