						...
						<tr class="<?php if ( in_array( $name, $core_fields ) ) echo 'core '; if ( ! $options[ 'enabled' ] ) echo 'disabled '; ?>" data-field-name="<?php echo esc_attr( $name ); ?>">
							...
							<td class="field-type">
								<?php if ( in_array( $name, array(
									...
									<span class="na tips" data-tip="<?php esc_attr_e( 'This field is address locale dependent and cannot be modified.', 'woocommerce-checkout-field-editor' ); ?>">&ndash;</span>
								<?php elseif ( in_array( $name, array( 'order_comments' ) ) ) : ?>
									<span class="na tips" data-tip="<?php esc_attr_e( 'This field cannot be modified.', 'woocommerce-checkout-field-editor' ); ?>">&ndash;</span>
								<?php else : ?>
									<?php if ( version_compare( WC_VERSION, '3.0.0', '>=' ) ) { ?>
							...
							<td class="field-options" style="width:150px;">
								...
								<?php else : ?>
									...
									<input type="text" class="input-text options" name="field_options[<?php echo esc_attr( $i ); ?>]" placeholder="<?php esc_attr_e( 'Pipe (|) separate options.', 'woocommerce-checkout-field-editor' ); ?>" value="<?php if ( isset( $options['options'] ) ) echo implode( ' | ', $options['options'] ); ?>" />
