...
//			}
	...
	function settings_link( $links ) {
		$settings_link = '<a href="' . admin_url( 'admin.php' ) . '?page=woo_thank_you_page_customizer" title="' . __( 'Settings', 'woo-thank-you-page-customizer' ) . '">' . __( 'Settings', 'woo-thank-you-page-customizer' ) . '</a>';
                        ...
                        <table class="form-table">
                            ...
                            <tr valign="top">
                                ...
                                <td>
									...
									?>
                                    <a target="_blank"
                                       href="<?php echo $url ?>"><?php esc_html_e( 'Go to design', 'woo-thank-you-page-customizer' ) ?></a>
                                </td>
                            </tr>
                        </table>
                    ...
                    <div class="vi-ui bottom attached tab segment" data-tab="coupon">
                        <table class="form-table wtyp-coupon-table">
                                ...
                                <td>
                                    <select class="search-coupon" name="existing_coupon" id="existing_coupon">
										...
										if ( $this->settings->get_params( 'existing_coupon' )[0] ) {
											...
											?>
                                            <option value="<?php echo $this->settings->get_params( 'existing_coupon' )[0] ?>"
                            ...
                            <tr valign="top" class="coupon-custom">
                                <th scope="row">
                                    <label for="coupon_custom"><?php esc_html_e( 'Custom', 'woo-thank-you-page-customizer' ) ?></label>
                                </th>
                                <td>
                                    <input type="text" name="coupon_custom" id="coupon_custom"
                                           value="<?php echo htmlentities( $this->settings->get_params( 'coupon_custom' )[0] ); ?>">
                                </td>
                            </tr>
                            ...
                            <tr valign="top" class="coupon-unique">
                                ...
                                <td>
                                    <input type="number" name="coupon_unique_amount" id="coupon_unique_amount"
                                           min="0"
                                           value="<?php echo $this->settings->get_params( 'coupon_unique_amount' )[0] ?>">
                                </td>
                            </tr>
                            <tr valign="top" class="coupon-unique">
                                <th scope="row">
                            ...
                            <tr valign="top" class="coupon-unique">
                                ...
                                <td>
                                    <input type="number" name="coupon_unique_date_expires"
                                           ...
                                           min="0"
                                           value="<?php echo $this->settings->get_params( 'coupon_unique_date_expires' )[0] ?>">
                                </td>
                            </tr>
                            ...
                            <tr valign="top" class="coupon-unique">
                                ...
                                <td>
                                    <input type="number" name="coupon_unique_minimum_amount"
                                           ...
                                           min="0"
                                           value="<?php echo $this->settings->get_params( 'coupon_unique_minimum_amount' )[0] ?>">
                                </td>
                            </tr>
                            <tr valign="top" class="coupon-unique">
                                <th scope="row">
                                ...
                                <td>
                                    <input type="number" name="coupon_unique_maximum_amount"
                                           ...
                                           min="0"
                                           value="<?php echo $this->settings->get_params( 'coupon_unique_maximum_amount' )[0] ?>">
                                </td>
                            </tr>
                            ...
                            <tr valign="top" class="coupon-unique">
                                ...
                                <td>
                                    <input type="number" name="coupon_unique_usage_limit"
                                           ...
                                           min="0"
                                           value="<?php echo $this->settings->get_params( 'coupon_unique_usage_limit' )[0] ?>">
                                </td>
                            </tr>
                            <tr valign="top" class="coupon-unique">
                                <th scope="row">
                                ...
                                <td>
                                    <input type="number" name="coupon_unique_limit_usage_to_x_items"
                                           ...
                                           min="0"
                                           value="<?php echo $this->settings->get_params( 'coupon_unique_limit_usage_to_x_items' )[0] ?>">
                                </td>
                            </tr>
                            <tr valign="top" class="coupon-unique">
                                <th scope="row">
                                ...
                                <td>
                                    <input type="number" name="coupon_unique_usage_limit_per_user"
                                           ...
                                           min="0"
                                           value="<?php echo $this->settings->get_params( 'coupon_unique_usage_limit_per_user' )[0] ?>">
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="form-table">
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    <p class="description"><?php echo __( 'Send coupon email if coupon is given on thank you page', 'woo-thank-you-page-customizer' ) ?></p>
                                </td>
                            </tr>
                            <tr valign="top">
                                <th scope="row">
                                ...
                                <td>
                                    ...
                                    <p class="description"><?php echo __( '', 'woo-thank-you-page-customizer' ) ?></p>
                                </td>
                            </tr>
                            <tr valign="top">
                                <th scope="row">
