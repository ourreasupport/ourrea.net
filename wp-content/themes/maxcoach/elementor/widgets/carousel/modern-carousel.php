...
class Widget_Modern_Carousel extends Carousel_Base {
	...
	public function get_title() {
		return esc_html__( 'Modern Carousel', 'maxcoach' );
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'maxcoach-modern-carousel' );
		?>
	...
	private function add_content_section() {
		...
		$this->add_control( 'style', [
			...
			'default'      => '01',
			'prefix_class' => 'maxcoach-modern-carousel-style-',
		...
		$repeater->add_control( 'tags', [
			...
			'type'        => Controls_Manager::TEXTAREA,
			'placeholder' => esc_html__( 'One tag per line', 'maxcoach' ),
		] );
