...
class Widget_Team_Member_Carousel extends Static_Carousel {
	...
	public function get_title() {
		return esc_html__( 'Team Member Carousel', 'maxcoach' );
	}
	...
	protected function add_repeater_controls( Repeater $repeater ) {
		...
		$repeater->add_control( 'socials', [
			'label'       => esc_html__( 'Socials', 'maxcoach' ),
			'description' => esc_html__( 'One social per line. Icon class & url separator with |. For eg: fab fa-facebook|https://facebook.com', 'maxcoach' ),
			'type'        => Controls_Manager::TEXTAREA,
		] );
	}
