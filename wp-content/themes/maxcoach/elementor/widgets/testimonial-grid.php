...
class Widget_Testimonial_Grid extends Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonial Masonry', 'maxcoach' );
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'items', [
			...
			'default'     => [
				[
					...
					'position'  => esc_html__( 'CEO', 'maxcoach' ),
				],
				[
					'thumbnail' => [ 'url' => $placeholder_image_src ],
					'content'   => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'maxcoach' ),
		...
		$this->add_group_control( Group_Control_Image_Size::get_type(), [
			...
			'fields_options' => [
				'size' => [
					'label' => esc_html__( 'Thumbnail Size', 'maxcoach' ),
				],
			],
		] );
		...
		$this->add_group_control( Group_Control_Image_Size::get_type(), [
			...
			'fields_options' => [
				'size' => [
					'label' => esc_html__( 'Avatar Size', 'maxcoach' ),
				],
			],
		] );
				...
				<?php foreach ( $settings['items'] as $item ) : ?>
					...
					<div <?php $this->print_attributes_string( $this->get_current_key() ); ?>>
						...
						$this->add_render_attribute( $this->get_current_key() . '-testimonial', [
							'class' => 'maxcoach-box testimonial-item',
						] );
						?>
	...
	private function print_testimonial_thumbnail() {
		...
		?>
		<div class="maxcoach-image thumbnail">
			<?php echo \Maxcoach_Image::get_elementor_attachment( [
				'settings'       => $item,
				'image_key'      => 'thumbnail',
	...
	private function print_layout() {
		...
		<?php if ( $item['content'] ) : ?>
			<div class="content">
				...
				<div class="text">
					<?php echo wp_kses( $item['content'], 'maxcoach-default' ); ?>
				</div>
			</div>
		<?php endif; ?>
