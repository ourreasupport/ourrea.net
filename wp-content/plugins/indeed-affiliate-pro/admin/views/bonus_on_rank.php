			<form action="" method="post">
				<div class="uap-stuffbox">
					<h3 class="uap-h3"><?php _e('Bonus On Ranks', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/bonus-on-ranks/" target="_blank"><?php _e('Need Help?', 'uap');?></a></span></h3>
					<div class="inside">
						<div class="row">
						<div class="col-xs-4">
							...
							<?php foreach ($data['rank_list'] as $id=>$label) :?>
									<div class="input-group" style="margin-bottom:20px;">
										<span class="input-group-addon" id="basic-addon1"><?php echo $label;?></span>
									 		<input type="number" class="form-control" min="0" step='<?php echo uapInputNumerStep();?>' class="uap-input-number" value="<?php echo $data['rank_value_array'][$id];?>" name="<?php echo "bonus_ranks_value[$id]";?>" />
