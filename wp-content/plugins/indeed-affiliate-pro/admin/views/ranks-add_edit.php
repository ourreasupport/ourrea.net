						...
						<div class="col-xs-8">
							...
							<div style="margin-top:15px;" class="col-xs-2">
								<div class="input-group">
									...
									<input type="number" min="1" style="min-width: 70px;" class="form-control" onChange="uapRankChangeOrderPreview(<?php echo $data['metas']['id'];?>, this.value);" onKeyUp="uapRankChangeOrderPreview(<?php echo $data['metas']['id'];?>, this.value);" max="<?php echo $data['maximum_ranks'];?>" value="<?php echo $data['metas']['rank_order'];?>" name="rank_order" />
								</div>
							 </div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-xs-4">
							...
							<div style="" id="achieve_rules">
								...
								<div onClick="uapAddNewAchieveRule();" id="add_new_achieve" class="button button-primary button-large" ><i class="fa-uap fa-add-new-item-uap" style="margin-right: 5px;"></i>Add</div>
								...
								?></div>
								<div id="achieve_reset" onClick="uapAchieveReset();" class="button button-primary button-large" style="display: <?php if ($is_edit) echo 'inline-block'; else echo 'none';?>;">Reset Achievement</div>
							</div>
							...
							<div style="margin-bottom:15px;">
                                ...
                                <?php
                                    ...
                                    foreach ($color_scheme as $color){
                                        ...
                                        ?>
                                            <li class="<?php echo $class;?>" onClick="uapChageColor(this, '<?php echo $color;?>', '#uap_color');" style="background-color: #<?php echo $color;?>;"></li>
                                        <?php
                                        $i++;
                                    }
                                ?>
