...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '01', 'dark', false ),
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '01', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '01', 'dark', false ),
	'active_callback' => array(
		array(
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '01', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'dark_button_color',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '01', 'light', false ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '01', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '01', 'light', false ),
	'active_callback' => array(
		array(
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '01', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'light_button_color',
			'operator' => '==',
