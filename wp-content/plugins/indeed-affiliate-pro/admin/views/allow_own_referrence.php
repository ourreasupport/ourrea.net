			<form action="" method="post">
				<div class="uap-stuffbox">
					<h3 class="uap-h3"><?php _e('Allow Own Referrence', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/allow-own-reference/" target="_blank"><?php _e('Need Help?', 'uap');?></a></span></h3>
					<div class="inside">
					<div class="row">
						<div class="col-xs-7">
							...
							<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
								...
								<input type="checkbox" class="uap-switch" onClick="uapCheckAndH(this, '#uap_allow_own_referrence_enable');" <?php echo $checked;?> />
