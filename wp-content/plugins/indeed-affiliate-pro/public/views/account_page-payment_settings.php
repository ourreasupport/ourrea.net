...
<form action="" method="post" class="uap-change-password-form">
	...
	<div class="uap-ap-field" id="uap_payment_with_stripe_v2" style="display: none;">
		...
		<div class="uap-stripe-v2-field uap-js-transit-number" data-country="ca" data-type="all">
			<label class="uap-ap-label"><?php _e("Transit Number", 'uap');?></label>
			<input type="text" class="uap-public-form-control" name="stripe_v2_meta_data[transit_number]" value="<?php echo $data['stripe_v2']['transit_number'];?>" />
		</div>

		<div class="uap-stripe-v2-field uap-js-institution-number" data-country="ca" data-type="all">
			<label class="uap-ap-label"><?php _e("Institution Number", 'uap');?></label>
			<input type="text" class="uap-public-form-control" name="stripe_v2_meta_data[institution_number]" value="<?php echo $data['stripe_v2']['institution_number'];?>" />
		</div>
