...
class Modify_Widget_Section extends Modify_Base {
	...
	public function section_layout( $element ) {
		...
		if ( isset( $gap_options['default'] ) ) {
			$gap_options['default'] = esc_html__( 'Normal', 'maxcoach' );
		}

		// Add new gap option 'custom'.
		if ( ! isset( $gap_options['custom'] ) ) {
			$gap_options['custom'] = esc_html__( 'Custom', 'maxcoach' );
		}
		...
		$element->add_control( 'gap_beside', [
			'label'        => esc_html__( 'Gap Beside', 'maxcoach' ),
			'type'         => Controls_Manager::SELECT,
			'default'      => 'yes',
			'options'      => [
				'no'  => esc_html__( 'No', 'maxcoach' ),
				'yes' => esc_html__( 'Yes', 'maxcoach' ),
			],
		...
		$element->add_responsive_control( 'gap_width', [
			'label'     => esc_html__( 'Gap Width', 'maxcoach' ),
		...
		$element->add_control( 'column_vertical_alignment', [
			'label'                => esc_html__( 'Column Vertical Alignment', 'maxcoach' ),
			'label_block'          => true,
			'type'                 => Controls_Manager::CHOOSE,
