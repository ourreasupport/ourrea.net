<form action="" method="post">
	...
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php _e('Source Details', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/source-details/" target="_blank"><?php _e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
			<div class="row">
				<div class="col-xs-7">
					...
					<input type="checkbox" class="uap-switch" onClick="uapCheckAndH(this, '#uap_source_details_enable');" <?php echo $checked;?> />
			...
			<div class="row">
				<div class="col-xs-7">
					...
					<?php foreach ($data['fields_available'] as $k=>$v):?>
						...
						<div><input type="checkbox" <?php echo $checked;?> value="<?php echo $k;?>" onClick="uapMakeInputhString(this, this.value, '#uap_source_details_woo_fields_list');" /> <?php echo $v;?></div>
					<?php endforeach;?>
				</div>
			</div>
		...
		<div class="inside">
			<div class="row">
				<div class="col-xs-7">
					...
					<?php foreach ($data['fields_available'] as $k=>$v):?>
						<?php $checked = (in_array($k, $temp)) ? 'checked' : '';?>
						<div><input type="checkbox" <?php echo $checked;?> value="<?php echo $k;?>" onClick="uapMakeInputhString(this, this.value, '#uap_source_details_edd_fields_list');" /> <?php echo $v;?></div>
					<?php endforeach;?>
				</div>
			</div>
		...
		<div class="inside">
			<div class="row">
				<div class="col-xs-7">
					...
					<?php foreach ($data['fields_available'] as $k=>$v):?>
						<?php $checked = (in_array($k, $temp)) ? 'checked' : '';?>
						<div><input type="checkbox" <?php echo $checked;?> value="<?php echo $k;?>" onClick="uapMakeInputhString(this, this.value, '#uap_source_details_ump_fields_list');" /> <?php echo $v;?></div>
					<?php endforeach;?>
				</div>
			</div>
		...
		<div class="inside">
			<div class="row">
				<div class="col-xs-7">
					...
					<?php foreach ($data['fields_available'] as $k=>$v):?>
						<?php $checked = (in_array($k, $temp)) ? 'checked' : '';?>
						<div><input type="checkbox" <?php echo $checked;?> value="<?php echo $k;?>" onClick="uapMakeInputhString(this, this.value, '#uap_source_details_signup_fields_list');" /> <?php echo $v;?></div>
					<?php endforeach;?>
				</div>
			</div>
