...
class LP_Addon_Paid_Memberships_Pro extends LP_Addon {
	...
	public function frontend_enqueue_scripts() {
		...
		if ( LP_ADDON_PMPRO_DEBUG ) {
			wp_register_style( 'learn-press-pmpro-style', LP_ADDON_PMPRO_URL . 'assets/lp-pms-style.css', array(), $v_rand );
		} else {
			wp_register_style( 'learn-press-pmpro-style', LP_ADDON_PMPRO_URL . 'assets/lp-pms-style.min.css', array(), LP_ADDON_PMPRO_VER );
		}
	...
	public function admin_enqueue_scripts() {
		...
		if ( LP_ADDON_PMPRO_DEBUG ) {
			wp_register_script( 'learn-press-pmpro-script', LP_ADDON_PMPRO_URL . 'assets/admin-lp-pms.js', array(), $v_rand, true );
		} else {
			wp_register_script( 'learn-press-pmpro-script', LP_ADDON_PMPRO_URL . 'assets/admin-lp-pms.min.js', array(), LP_ADDON_PMPRO_VER, true );
		}

		if ( $screen ) {
			if ( $screen->id == 'memberships_page_pmpro-membershiplevels' ) {
				wp_enqueue_script( 'learn-press-pmpro-script' );
			}
		}
	}
