<form action="" method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php _e('Wallet', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/wallet/" target="_blank"><?php _e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
			<div class="row">
				<div class="col-xs-8">
					...
					<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
						...
						<input type="checkbox" class="uap-switch" onClick="uapCheckAndH(this, '#uap_wallet_enable');" <?php echo $checked;?> />
					...
					<div class="input-group" style="margin-top: 10px;">
						...
						<div>
								<?php
									...
									<div>
										<input type="checkbox" <?php if (in_array($key, $temp)) echo 'checked';?> onClick="uapMakeInputhString(this, '<?php echo $key;?>', '#uap_wallet_exclude_sources');" /> <?php echo $value;?>
									</div>
								<?php endforeach;?>
						</div>
