<?php
$colored_bg = Maxcoach_Portfolio::instance()->get_the_post_meta( 'portfolio_overlay_colored_faded_background' );
$style      = '';

$overlay_content_extra_class = '';
if ( ! empty( $colored_bg ) ) {
	$colored_text_skin = Maxcoach_Portfolio::instance()->get_the_post_meta( 'portfolio_overlay_colored_faded_text_skin' );
