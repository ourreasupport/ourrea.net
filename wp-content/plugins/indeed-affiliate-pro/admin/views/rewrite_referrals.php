			<form action="" method="post">
				<div class="uap-stuffbox">
					<h3 class="uap-h3"><?php _e('ReWrite Referrals', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/reassign-referral/" target="_blank"><?php _e('Need Help?', 'uap');?></a></span></h3>
					<div class="inside">
					<div class="row">
						<div class="col-xs-8">
...
Example: John is a customer that is linked to Smith (affiliate). John enters the website but does not buy anything. Later, John enters the website through Bob's link (affiliate) and makes a purchase. You can decide if John will be linked to the first affiliate (Smith), or the last one (Bob), therefore deciding which affiliate will receive referral.", 'uap');?></p>
							<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
								...
								<input type="checkbox" class="uap-switch" onClick="uapCheckAndH(this, '#uap_rewrite_referrals_enable');" <?php echo $checked;?> />
