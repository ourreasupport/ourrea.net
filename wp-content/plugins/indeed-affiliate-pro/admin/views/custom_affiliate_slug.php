...
<form action="" method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php _e('Custom Affiliate Slug', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/custom-affiliate-slug/" target="_blank"><?php _e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
			<div class="row">
				<div class="col-xs-7">
					...
					<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
						...
						<input type="checkbox" class="uap-switch" onClick="uapCheckAndH(this, '#uap_custom_affiliate_slug_on');" <?php echo $checked;?> />
	...
	<div class="uap-stuffbox">
		...
		<div class="inside">
			...
			<div class="uap-submit-form" style="margin-top: 10px;">
				<input type="submit" value="<?php _e('Save Changes', 'uap');?>" name="save_slug" class="button button-primary button-large" />
			</div>
		</div>
	</div>
</form>
			...
			<tfoot>
				...
				foreach ($data['items'] as $item):?>
					<tr class="<?php if($i%2==0) echo 'alternate';?>">
						...
						<td><i class="fa-uap fa-trash-uap" onClick="uapRemoveSlug(<?php echo $item['user_id'];?>);"></i></td>
					</tr>
				<?php $i++;
				endforeach;?>
		</table>
