...
class Widget_Product extends Posts_Base {
	...
	public function get_title() {
		return esc_html__( 'Product', 'maxcoach' );
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'maxcoach-grid-wrapper maxcoach-product style-grid' );
	...
	private function add_caption_style_section() {
		...
		$this->add_control( 'caption_title_heading', [
			'label'     => esc_html__( 'Product Name', 'maxcoach' ),
		...
		$this->add_control( 'caption_price_heading', [
			'label'     => esc_html__( 'Product Price', 'maxcoach' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'label'    => esc_html__( 'Decimals Typography', 'maxcoach' ),
		...
		$this->start_controls_tab( 'caption_regular_price_tab', [
			'label' => esc_html__( 'Regular', 'maxcoach' ),
		] );
		...
		$this->add_control( 'caption_regular_price_decimals_color', [
			'label'     => esc_html__( 'Decimals Color', 'maxcoach' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$this->start_controls_tab( 'caption_sale_price_tab', [
			'label' => esc_html__( 'Sale', 'maxcoach' ),
		] );
