	...
	if ( ! class_exists( 'WOO_THANK_YOU_PAGE_CUSTOMIZER_Blocks_Control' ) ) {
		class WOO_THANK_YOU_PAGE_CUSTOMIZER_Blocks_Control extends WP_Customize_Control {
			...
			public function render_content() {
				...
				$block_titles   = array(
					'thank_you_message'    => __( 'Thank you message', 'woo-thank-you-page-customizer' ),
					'order_confirmation'   => __( 'Order confirmation', 'woo-thank-you-page-customizer' ),
					'order_details'        => __( 'Order details', 'woo-thank-you-page-customizer' ),
					'customer_information' => __( 'Customer information', 'woo-thank-you-page-customizer' ),
					'coupon'               => __( 'Coupon', 'woo-thank-you-page-customizer' ),
					'social_icons'         => __( 'Social icons', 'woo-thank-you-page-customizer' ),
					'google_map'           => __( 'Google map', 'woo-thank-you-page-customizer' ),
					'order_again'          => __( 'Order again', 'woo-thank-you-page-customizer' ),
					'text_editor'          => __( 'Text editor', 'woo-thank-you-page-customizer' ),
                                ...
                                <div class="<?php echo $this->set( array(
													...
													foreach ( $block_value as $block_value_k => $block_value_v ) {
                                                        ...
                                                        <div class="<?php echo $this->set( array(
                                                            ...
                                                            <span class="<?php echo $this->set( 'edit' ) ?> wtyp_icons-edit"
                                                                  title="<?php _e( 'Edit this item', 'woo-thank-you-page-customizer' ) ?>"></span>
                                                            <span class="<?php echo $this->set( 'remove' ) ?> wtyp_icons-cancel"
                                                                  title="<?php _e( 'Remove this item', 'woo-thank-you-page-customizer' ) ?>"></span>
                                                        </div>
														<?php
													}
													?>
                                                    <div class="<?php echo $this->set( array(
                                                        ...
                                                        <span class="<?php echo $this->set( array(
	                                                        'edit-block-add-item',
                                                              ...
                                                              title="<?php _e( 'Add items', 'woo-thank-you-page-customizer' ) ?>">+</span>
                                                    </div>
                                                </div>
												<?php
											} else {
                                    ...
                                    <span class="<?php echo $this->set( array(
										'remove-row',
                                          ...
                                          title="<?php _e( 'Remove', 'woo-thank-you-page-customizer' ) ?>"></span>
                                </div>
								<?php
							}
						}
                ...
                <h3 class="<?php echo $this->set( 'add-row-title' ) ?>"><?php echo __( 'Click on items below to add row', 'woo-thank-you-page-customizer' ) ?></h3>
                <div class="<?php echo $this->set( 'add-row-container' ) ?>">
					...
					for ( $i = 1; $i <= 4; $i ++ ) {
                        ...
                        <span class="<?php echo $this->set( array( 'add-row', 'row-' . $i . '-column' ) ) ?>"
                              ...
                              title="<?php printf( __( 'Add an %s-columns row', 'woo-thank-you-page-customizer' ), $i ) ?>">
                            <?php
                            for ( $j = 1; $j <= $i; $j ++ ) {
	                            ?>
                ...
                <div class="<?php echo $this->set( 'components-container' ) ?>">
                    ...
                    <div class="<?php echo $this->set( 'components' ) ?>">
                        ...
                        <h3 class="<?php echo $this->set( 'available-components' ) ?>"><?php echo __( 'Available components', 'woo-thank-you-page-customizer' ) ?></h3>
		...
		class WOO_THANK_YOU_PAGE_CUSTOMIZER_Text_Editor_Control extends WP_Customize_Control {
			...
			public function render_content() {
                ...
                <div class="customize-control-content">
					...
					$value1 = json_encode( array_map( 'base64_encode', $value ) );
					?>
                    <input type="hidden" name="<?php esc_attr_e( $this->id ); ?>" id="<?php esc_attr_e( $class ); ?>"
                           value="<?php echo htmlentities( $value1 ); ?>"
                           class="<?php echo $class; ?>" <?php $this->link(); ?>/>
                </div>
				<?php
			}
