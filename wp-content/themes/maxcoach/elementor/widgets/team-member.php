...
class Widget_Team_Member extends Base {
	...
	public function get_title() {
		return esc_html__( 'Team Member', 'maxcoach' );
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'style', [
			...
			'prefix_class' => 'maxcoach-team-member-style-',
		] );
		...
		$this->add_control( 'profile', [
			'label'         => esc_html__( 'Profile', 'maxcoach' ),
		...
		$this->add_control( 'social_networks', [
			...
			'default'     => [
				...
				[
					'title' => esc_html__( 'Youtube Channel', 'maxcoach' ),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'tm-team-member maxcoach-box' );
		?>
					...
					<div class="info">
						...
						<?php if ( $settings['content'] !== '' ) : ?>
							<div class="description">
								<?php echo wp_kses( $settings['content'], 'maxcoach-default' ); ?>
							</div>
						<?php endif; ?>
					</div>
				<?php endif; ?>
