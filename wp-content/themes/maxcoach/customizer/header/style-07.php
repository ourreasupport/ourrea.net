...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => defined( 'MAXCOACH_DEMO_BUTTON_TEXT' ) ? MAXCOACH_DEMO_BUTTON_TEXT : esc_html__( 'Buy Now', 'maxcoach' ),
) );
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => defined( 'MAXCOACH_DEMO_BUTTON_LINK' ) ? MAXCOACH_DEMO_BUTTON_LINK : '#',
) );
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'section'  => $section,
	'priority' => $priority++,
	'default'  => defined( 'MAXCOACH_DEMO_BUTTON_LINK_TARGET' ) ? MAXCOACH_DEMO_BUTTON_LINK_TARGET : '0',
	'choices'  => array(
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '07', 'dark', false ),
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '07', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '07', 'dark', false ),
	'active_callback' => array(
		array(
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '07', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'dark_button_color',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '07', 'light', false ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '07', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '07', 'light', false ),
	'active_callback' => array(
		array(
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '07', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'light_button_color',
			'operator' => '==',
