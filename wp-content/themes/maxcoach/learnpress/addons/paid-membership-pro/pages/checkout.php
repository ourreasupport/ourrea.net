...
<div id="pmpro_level-<?php echo $pmpro_level->id; ?>">
	<form id="pmpro_form" class="pmpro_form" action="<?php if ( ! empty( $_REQUEST['review'] ) ) {
		...
		<?php if ( $pmpro_review ) { ?>
			<p><?php esc_html_e( 'Almost done. Review the membership information and pricing below then <strong>click the "Complete Payment" button</strong> to finish your order.', 'maxcoach' ); ?></p>
		<?php } ?>

		<div class="maxcoach-tabpanel maxcoach-tabpanel-horizontal membership-checkout-tabs">
			<ul class="maxcoach-nav-tabs">
				<li>
					<a href="#"><span
							class="nav-tab-title"><?php esc_html_e( 'Membership Level', 'maxcoach' ); ?></span></a>
				</li>
				<li>
					<a href="#"><span
							class="nav-tab-title"><?php esc_html_e( 'Account Information', 'maxcoach' ); ?></span></a>
				</li>
				<li><a href="#"><span
							class="nav-tab-title"><?php esc_html_e( 'Billing Address', 'maxcoach' ); ?></span></a>
				</li>
				<li><a href="#"><span
							class="nav-tab-title"><?php esc_html_e( 'Payment Information', 'maxcoach' ); ?></span></a>
				</li>
			</ul>
			<div class="maxcoach-tab-content">
				<div class="tab-panel">
					<div class="tab-mobile-heading"><?php esc_html_e( 'Membership Level', 'maxcoach' ); ?></div>
					<div class="tab-content">
						<div id="pmpro_pricing_fields" class="pmpro_checkout">
							<p class="pmpro_level_selected_text">
								<?php printf( __( 'You have selected the <strong class="heading-color">%s</strong> membership level.', 'maxcoach' ), $pmpro_level->name ); ?>

								<?php if ( count( $pmpro_levels ) > 1 ) { ?>
									<a href="<?php echo pmpro_url( "levels" ); ?>"
									   class="link-transition-alt"><?php esc_html_e( 'change', 'maxcoach' ); ?></a>
								<?php } ?>
							</p>
							...
							<div id="pmpro_level_cost">
								<?php if ( $discount_code && pmpro_checkDiscountCode( $discount_code ) ) { ?>
									<?php printf( __( '<p class="pmpro_level_discount_applied">The <strong>%s</strong> code has been applied to your order.</p>', 'maxcoach' ), $discount_code ); ?>
								<?php } ?>
								...
								<?php if ( $discount_code && ! $pmpro_review ) { ?>
									<p id="other_discount_code_p" class="pmpro_small">
										<a id="other_discount_code_a"
										   href="#discount_code"><?php esc_html_e( 'Click here to change your discount code', 'maxcoach' ); ?></a>.
									</p>
								<?php } elseif ( ! $pmpro_review ) { ?>
									<p id="other_discount_code_p"
									   class="pmpro_small"><?php esc_html_e( 'Do you have a discount code?', 'maxcoach' ); ?>
										<a id="other_discount_code_a"
										   href="#discount_code"><?php esc_html_e( 'Click here to enter your discount code', 'maxcoach' ); ?></a>.
									</p>
								<?php } elseif ( $pmpro_review && $discount_code ) { ?>
									<p>
										<strong><?php esc_html_e( 'Discount Code', 'maxcoach' ); ?>
							...
							<?php if ( $pmpro_show_discount_code ) { ?>
								<div id="other_discount_code_tr" style="display: none;">
									<div>
										<label
											for="other_discount_code"><?php esc_html_e( 'Discount Code', 'maxcoach' ); ?></label>
										...
										<input type="button" name="other_discount_code_button"
										       ...
										       value="<?php esc_html_e( 'Apply', 'maxcoach' ); ?>"/>
									</div>
								</div>
							<?php } ?>
						</div>
				...
				<div class="tab-panel">
					<div class="tab-mobile-heading"><?php esc_html_e( 'Account Information', 'maxcoach' ); ?></div>
					<div class="tab-content">
						<?php if ( ! $skip_account_fields && ! $pmpro_review ) { ?>
							<div id="pmpro_user_fields" class="pmpro_checkout">
								<p class="pmpro-section-title heading"><?php esc_html_e( 'Sign Up', 'maxcoach' ); ?></p>

								<p class="pmpro_thead-msg"><?php esc_html_e( 'Already have an account?', 'maxcoach' ); ?>
									<a href="<?php echo wp_login_url( pmpro_url( "checkout", "?level=" . $pmpro_level->id ) ) ?>"
									   class="link-transition-alt"><?php esc_html_e( 'Log in here', 'maxcoach' ); ?></a>
								</p>

								<div class="row">
									<div class="form-control col-md-6">
										<label
											for="username"><?php esc_html_e( 'Username', 'maxcoach' ); ?></label>
									...
									<div class="form-control col-md-6">
										<label
											for="bemail"><?php esc_html_e( 'Email', 'maxcoach' ); ?></label>
									...
									if ( $pmpro_checkout_confirm_email ) {
										...
										<div class="form-control col-md-6">
											<label
												for="bconfirmemail"><?php esc_html_e( 'Confirm Email', 'maxcoach' ); ?></label>
									...
									<div class="form-control col-md-6">
										<label
											for="password"><?php esc_html_e( 'Password', 'maxcoach' ); ?></label>
									...
									if ( $pmpro_checkout_confirm_password ) {
										...
										<div class="form-control col-md-6">
											<label
												for="password2"><?php esc_html_e( 'Confirm Password', 'maxcoach' ); ?></label>
								...
								<div class="pmpro_hidden">
									<label
										for="fullname"><?php esc_html_e( 'Full Name', 'maxcoach' ); ?></label>
									<input id="fullname" name="fullname" type="text"
									       class="input <?php echo pmpro_getClassForField( "fullname" ); ?>"
									       size="30"
									       value=""/>
									<strong><?php esc_html_e( 'LEAVE THIS BLANK', 'maxcoach' ); ?></strong>
								</div>
						...
						<?php } elseif ( $current_user->ID && ! $pmpro_review ) { ?>
							<p id="pmpro_account_loggedin">
								<?php printf( __( 'You are logged in as <strong>%s</strong>. If you would like to use a different account for this membership, <a href="%s">log out now</a>.', 'maxcoach' ), $current_user->user_login, wp_logout_url( $_SERVER['REQUEST_URI'] ) ); ?>
							</p>
						<?php } ?>
				...
				<div class="tab-panel">
					<div class="tab-mobile-heading"><?php esc_html_e( 'Billing Address', 'maxcoach' ); ?></div>
					<div class="tab-content">
						...
						<?php if ( pmpro_getGateway() == "paypal" && empty( $pmpro_review ) && true == apply_filters( 'pmpro_include_payment_option_for_paypal', true ) ) { ?>
							<table id="pmpro_payment_method" class="pmpro_checkout top1em" width="100%" cellpadding="0"
								...
								<thead>
								<tr>
									<th><?php esc_html_e( 'Choose your Payment Method', 'maxcoach' ); ?></th>
								</tr>
								</thead>
								<tbody>
								<tr>
						...
						<span class="gateway_paypal">
							...
							<a href="javascript:void(0);"
							   class="pmpro_radio"><?php esc_html_e( 'Check Out with a Credit Card Here', 'maxcoach' ); ?></a>
						</span>
							...
							<a href="javascript:void(0);"
							   class="pmpro_radio"><?php esc_html_e( 'Check Out with PayPal', 'maxcoach' ); ?></a>
						</span>
										</div>
									</td>
								</tr>
						...
						if ( $pmpro_include_billing_address_fields ) {
							...
							>
								<p class="pmpro-section-title heading">
									<?php esc_html_e( 'Billing Address', 'maxcoach' ); ?>
								</p>

								<div class="row">
									<div class="form-control col-md-6">
										<label
											for="bfirstname"><?php esc_html_e( 'First Name', 'maxcoach' ); ?></label>
									...
									<div class="form-control col-md-6">
										<label for="blastname"><?php esc_html_e( 'Last Name', 'maxcoach' ); ?></label>
									...
									<div class="form-control col-md-6">
										<label for="baddress1"><?php esc_html_e( 'Address 1', 'maxcoach' ); ?></label>
									...
									<div class="form-control col-md-6">
										<label for="baddress2"><?php esc_html_e( 'Address 2', 'maxcoach' ); ?></label>
									...
									if ( $longform_address ) {
										...
										<div class="form-control col-md-6">
											<label
												for="bcity"><?php esc_html_e( 'City', 'maxcoach' ); ?></label>
										...
										<div class="form-control col-md-6">
											<label
												for="bstate"><?php esc_html_e( 'State', 'maxcoach' ); ?></label>
										...
										<div class="form-control col-md-6">
											<label
												for="bzipcode"><?php esc_html_e( 'Postal Code', 'maxcoach' ); ?></label>
										...
										<div class="form-control col-md-12">
											<label
												for="bcity_state_zip"><?php esc_html_e( 'City, State Zip', 'maxcoach' ); ?></label>
											<input id="bcity" name="bcity" type="text"
											       class="input <?php echo pmpro_getClassForField( "bcity" ); ?>"
											       size="14"
											       value="<?php echo esc_attr( $bcity ) ?>"/>,
									...
									<div class="form-control col-md-6">
										<label for="bphone"><?php esc_html_e( 'Phone', 'maxcoach' ); ?></label>
									...
									if ( $show_country ) {
										?>
										<div class="form-control col-md-12">
											<label for="bcountry"><?php esc_html_e( 'Country', 'maxcoach' ); ?></label>
									...
									<?php if ( $skip_account_fields ) { ?>
										...
										?>
										<div class="form-control col-md-6">
											<label for="bemail"><?php esc_html_e( 'Email', 'maxcoach' ); ?></label>
											<input id="bemail" name="bemail"
											       type="<?php echo( $pmpro_email_field_type ? 'email' : 'text' ); ?>"
				...
				<div class="tab-panel">
					<div class="tab-mobile-heading"><?php esc_html_e( 'Payment Information', 'maxcoach' ); ?></div>
					<div class="tab-content">
						<?php
						...
						if ( $pmpro_include_payment_information_fields ) {
							...
							>
								<p class="pmpro-section-title heading">
									<?php printf( __( 'We Accept %s', 'maxcoach' ), $pmpro_accepted_credit_cards_string ); ?>
								</p>
								...
								<div class="row">
									...
									if ( $pmpro_include_cardtype_field ) {
										...
										<div class="pmpro_payment-card-type">
											<label
												for="CardType"><?php esc_html_e( 'Card Type', 'maxcoach' ); ?></label>
									...
									<div class="pmpro_payment-account-number form-control col-md-12">
										<label
											for="AccountNumber"><?php esc_html_e( 'Card Number', 'maxcoach' ); ?></label>
										<div class="row row-xs-center">
											...
											<div class="col-md-3">
												<div class="payment-group-cards">
													<img
														src="<?php echo MAXCOACH_THEME_IMAGE_URI . '/payment-group-cards.png'; ?>"
														alt="<?php esc_attr_e( 'Payment Cards', 'maxcoach' ); ?>">
												</div>
											</div>
										</div>
									</div>

									<div class="pmpro_payment-expiration form-control col-md-12">
										<label
											for="ExpirationMonth"><?php esc_html_e( 'Expiration Date', 'maxcoach' ); ?></label>
									...
									if ( $pmpro_show_cvv ) { ?>
										<div class="pmpro_payment-cvv form-control col-md-12">
											<label
												for="CVV"><?php esc_html_e( 'CVV', 'maxcoach' ); ?></label>
											...
											(<a href="javascript:void(0);"
											    onclick="javascript:window.open('<?php echo pmpro_https_filter( PMPRO_URL ) ?>/pages/popup-cvv.html','cvv','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=600, height=475');"><?php esc_html_e( "what's this?", 'maxcoach' ); ?></a>)
										</div>
									<?php } ?>
									...
									<?php if ( $pmpro_show_discount_code ) { ?>
										<div class="pmpro_payment-discount-code">
											<label
												for="discount_code"><?php esc_html_e( 'Discount Code', 'maxcoach' ); ?></label>
											<input
								...
								<tr class="odd">
									<td>
										...
										<label class="pmpro_normal pmpro_clickable"
										       for="tos"><?php printf( __( 'I agree to the %s', 'maxcoach' ), $tospage->post_title ); ?></label>
									</td>
								</tr>
								</tbody>
							</table>
				...
				<input type="submit" class="pmpro_btn pmpro_btn-submit-checkout"
				       value="<?php esc_html_e( 'Complete Payment', 'maxcoach' ); ?> &raquo;"/>
			</span>
									...
									<span id="pmpro_submit_span">
										...
										<input type="submit" class="pmpro_btn pmpro_btn-submit-checkout"
										       value="<?php if ( $pmpro_requirebilling ) {
											       esc_html_e( 'Submit and Check Out', 'maxcoach' );
										       } else {
											       esc_html_e( 'Submit and Confirm', 'maxcoach' );
										       } ?> &raquo;"/>
									</span>
									<?php
								}
							...
							<span id="pmpro_processing_message" style="visibility: hidden;">
								<?php
								$processing_message = apply_filters( "pmpro_processing_message", esc_html__( "Processing...", 'maxcoach' ) );
			...
			<!--<div class="maxcoach-tab-nav-buttons">
				<button class="tab-button maxcoach-tab-prev"
				        aria-controls="prev"><?php /*esc_html_e( 'Back', 'maxcoach' ); */ ?></button>
				<div class="tab-button-separator"></div>
				<button class="tab-button maxcoach-tab-next"
				        aria-controls="next"><?php /*esc_html_e( 'Next', 'maxcoach' ); */ ?></button>
			</div>-->
		</div>
