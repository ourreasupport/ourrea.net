			...
			<form action="" method="post">
				...
				<div class="uap-stuffbox">
					...
					<div class="inside">
                        ...
                        <div class="uap-form-line">
							<span class="uap-labels-special"><?php _e('After reset password:', 'uap');?></span>
							<select name="uap_general_after_reset_password_redirect">
								...
								<?php
									...
									if ($pages_arr){
										foreach ($pages_arr as $k=>$v){
											?>
												<option value="<?php echo $k;?>" <?php if($data['metas']['uap_general_after_reset_password_redirect']==$k)echo 'selected';?> ><?php echo $v;?></option>
											<?php
										}
									}
								?>
				...
				<div class="uap-stuffbox">
					...
					<div class="inside">
						...
						<div class="uap-form-line">
							<span class="uap-labels-special"><?php _e('Account Page - when affiliate user is not logged redirect to:', 'uap');?></span>
						...
						<div class="uap-form-line">
							<span class="uap-labels-special"><?php _e('Login Page - when affiliate user is already logged redirect to:', 'uap');?></span>
						...
						<div class="uap-form-line">
							<span class="uap-labels-special"><?php _e('Register Page - when affiliate user is already registered redirect to:', 'uap');?></span>
						...
						<div class="uap-form-line">
							<span class="uap-labels-special"><?php _e('LogOut Page - when affiliate user is not logged redirect to:', 'uap');?></span>
						...
						<div class="uap-form-line">
							<span class="uap-labels-special"><?php _e('Lost Password Page - when affiliate user is already logged redirect to:', 'uap');?></span>
