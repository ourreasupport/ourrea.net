	...
	<form action="<?php echo $data['pay_link'];?>" method="post" id="form_payments">
				<div class="uap-delete-wrapp">
					...
					<table class="wp-list-table widefat fixed tags uap-admin-tables">
						<thead>
							<tr>
								<th style="width: 30px;"><input type="checkbox" onClick="uapSelectAllCheckboxes( this, '.uap-referral' );" /></th>
						...
						<tbody class="ui-sortable uap-alternate">
							...
							<tr>
								...
								<th><input type="checkbox" value="<?php echo $array['id'];?>" name="referrals[]" class="uap-referral" <?php echo $checked;?> /></th>
								<td>
