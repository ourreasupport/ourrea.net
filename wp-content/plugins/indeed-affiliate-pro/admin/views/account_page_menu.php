...
<form action="" method="post">
	<div class="uap-stuffbox">
		<h3 class="uap-h3"><?php _e('Account Page - Customize Menu', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/account-custom-tabs/" target="_blank"><?php _e('Need Help?', 'uap');?></a></span></h3>
		<div class="inside">
			...
			<div class="uap-form-line">
				...
				<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
					...
					<input type="checkbox" class="uap-switch" onClick="uapCheckAndH(this, '#uap_account_page_menu_enabled');" <?php echo $checked;?> />
				...
				<div class="row" style="margin-left:0px;">
					<div class="col-xs-4" style="margin-bottom: 10px;">
				   		...
				   		<div class="input-group" style="margin:0px 0 15px 0;">
							...
							<div class="input-group" style="margin:0px 0 15px 0;">
									<span class="input-group-addon" id="basic-addon1"><?php _e('Link', 'uap');?></span>
									<input type="text" name="url" class="form-control" value="" />
							</div>
							<div style="margin-bottom: 30px;"><?php _e( 'Optional', 'uap' );?></div>
				   		<div class="input-group" style="margin:0px 0 15px 0;">
				...
				<table class="wp-list-table widefat fixed tags uap-admin-tables" id="uap_reorder_menu_items" style="width:100%;position:relative;">
					<thead>
						<tr>
							...
							<th class="manage-column"><?php _e('Link', 'uap');?></th>
