...
class VI_WOO_THANK_YOU_PAGE_Frontend_Account {
	...
	public function woocommerce_my_account_my_orders_column_wtypc_coupon( $order ) {
		...
		if ( $coupon_code ) {
			...
			if ( $coupon ) {
				...
				$title        .= sprintf( __( 'Used: %s/%s.', 'woo-thank-you-page-customizer' ), $usage_count, $usage_limit, 'woo-thank-you-page-customizer' );
				$today        = strtotime( 'today' );
				$date_expires = $coupon->get_date_expires();
				$expires      = __( 'Never', 'woo-thank-you-page-customizer' );
				...
				$coupon_info = sprintf( __( '(%s - Expires: %s)', 'woo-thank-you-page-customizer' ), $coupon_amount, $expires, 'woo-thank-you-page-customizer' );
	...
	public function woocommerce_account_orders_columns( $columns ) {
		if ( isset( $columns['order-actions'] ) ) {
			...
			$columns['wtypc_coupon']  = __( 'Coupon gift', 'woo-thank-you-page-customizer' );
