...
class VI_WOO_THANK_YOU_PAGE_Frontend_Frontend {
	...
	public function send_email_action() {
		...
		$message_fail = __( 'There was problem sending email but you can always view your coupon gift by going to Account settings/Orders', 'woo-thank-you-page-customizer' );
		if ( $order_id && $email && $coupon_code ) {
			if ( get_transient( 'woocommerce_thank_you_page_customizer_send_email_' . $order_id ) ) {
				wp_send_json( array(
					'message' => __( 'Coupon code was sent to your billing email. If you did not receive any email, please go to Account settings/Orders to view your coupon gift anytime.', 'woo-thank-you-page-customizer' ),
				) );
				die;
			} else {
				...
				if ( $coupon ) {
					...
					if ( $send ) {
						...
						wp_send_json( array(
							'message' => __( 'Coupon code was sent to your billing email.', 'woo-thank-you-page-customizer' ),
						) );
						die;
					} else {
						wp_send_json( array(
	...
	public function shortcut_to_shortcodes( $editor_id ) {
		if ( $editor_id == 'woocommerce-thank-you-page-wp-editor' ) {
			ob_start();
			?>
            <span class="<?php echo $this->set( 'available-shortcodes-shortcut' ) ?>"><?php esc_html_e( 'Shortcodes', 'woo-thank-you-page-customizer' ) ?></span>
			<?php
			echo ob_get_clean();
		}
	}
		...
		if ( is_customize_preview() && ! empty( $_REQUEST['customize_messenger_channel'] ) ) {
			...
			if ( $order && is_array( $order_status ) && count( $order_status ) && in_array( 'wc-' . $order->get_status(), $order_status ) ) {
				...
				wp_localize_script( 'woocommerce-thank-you-page-script', 'woocommerce_thank_you_page_customizer_params', array(
					...
					'copied_message' => __( 'Coupon code is copied to clipboard.', 'woo-thank-you-page-customizer' ),
				) );
	...
	public function wp_footer() {
		...
		$shortcode_titles = array(
			'coupon_code'         => __( 'Coupon code', 'woo-thank-you-page-customizer' ),
			'coupon_code_style_1' => __( 'Coupon code style 1', 'woo-thank-you-page-customizer' ),
			'coupon_date_expires' => __( 'Coupon\'s date expires', 'woo-thank-you-page-customizer' ),
			'last_valid_date'     => __( 'Coupon\'s last valid date', 'woo-thank-you-page-customizer' ),
			'coupon_amount'       => __( 'Coupon amount', 'woo-thank-you-page-customizer' ),
			'shop_title'          => __( 'Shop title', 'woo-thank-you-page-customizer' ),
			'home_url'            => __( 'Home url', 'woo-thank-you-page-customizer' ),
			'shop_url'            => __( 'Shop url', 'woo-thank-you-page-customizer' ),
			'order_number'        => __( 'Order number', 'woo-thank-you-page-customizer' ),
			'order_status'        => __( 'Order status', 'woo-thank-you-page-customizer' ),
			'order_date'          => __( 'Order date', 'woo-thank-you-page-customizer' ),
			'order_total'         => __( 'Order total', 'woo-thank-you-page-customizer' ),
			'order_subtotal'      => __( 'Order subtotal', 'woo-thank-you-page-customizer' ),
			'items_count'         => __( 'Items count', 'woo-thank-you-page-customizer' ),
			'payment_method'      => __( 'Payment method', 'woo-thank-you-page-customizer' ),

			'shipping_method'            => __( 'Shipping method', 'woo-thank-you-page-customizer' ),
			'shipping_address'           => __( 'Shipping address', 'woo-thank-you-page-customizer' ),
			'formatted_shipping_address' => __( 'Formatted shipping address', 'woo-thank-you-page-customizer' ),

			'billing_address'           => __( 'Billing address', 'woo-thank-you-page-customizer' ),
			'formatted_billing_address' => __( 'Formatted billing address', 'woo-thank-you-page-customizer' ),
			'billing_country'           => __( 'Billing country', 'woo-thank-you-page-customizer' ),
			'billing_city'              => __( 'Billing city', 'woo-thank-you-page-customizer' ),

			'billing_first_name'          => __( 'Billing first name', 'woo-thank-you-page-customizer' ),
			'billing_last_name'           => __( 'Billing last name', 'woo-thank-you-page-customizer' ),
			'formatted_billing_full_name' => __( 'Formatted billing full name', 'woo-thank-you-page-customizer' ),
			'billing_email'               => __( 'Billing email', 'woo-thank-you-page-customizer' ),
		);
		if ( is_array( $this->shortcodes ) && count( $this->shortcodes ) ) {
			?>
            <div class="<?php echo $this->set( array( 'available-shortcodes-container', 'hidden' ) ) ?>">
                ...
                <div class="<?php echo $this->set( 'available-shortcodes-items' ) ?>">
                    <div class="<?php echo $this->set( 'available-shortcodes-items-header' ) ?>">
						<?php _e( 'Available shortcode', 'woo-thank-you-page-customizer' ) ?>
                    ...
                    <div class="<?php echo $this->set( 'available-shortcodes-items-content' ) ?>">
						...
						foreach ( $this->shortcodes as $key => $value ) {
                            ...
                            <div class="<?php echo $this->set( 'available-shortcodes-item' ) ?>">
                                <div class="<?php echo $this->set( 'available-shortcodes-item-name' ) ?>"><?php echo isset( $shortcode_titles[ $key ] ) ? $shortcode_titles[ $key ] : __( ucwords( str_replace( '_', ' ', $key ) ), 'woo-thank-you-page-customizer' ) ?></div>
        ...
        <div class="<?php echo $this->set( 'wp-editor-container' ) ?>">
            ...
            <div class="<?php echo $this->set( 'wp-editor-handle' ) ?>">
                <span class="<?php echo $this->set( 'wp-editor-save' ) ?>"><?php esc_html_e( 'OK', 'woo-thank-you-page-customizer' ) ?></span>
                <span class="<?php echo $this->set( 'wp-editor-cancel' ) ?>"><?php esc_html_e( 'Cancel', 'woo-thank-you-page-customizer' ) ?></span>
            </div>
        </div>
											...
											foreach ( $block_value as $block_value_k => $block_value_v ) {
												switch ( $block_value_v ) {
													case 'order_confirmation':
														echo $this->order_confirmation_html( $order, $order_confirmation_header );
														break;
													case 'order_details':
														echo $this->order_details_html( $order, $order_details_header, $order_details_product_image, $order_details_product_quantity_in_image );
														break;
													case 'customer_information':
														echo $this->customer_information_html( $order, $customer_information_header );
														break;
													case 'social_icons':
	...
	public function the_content( $content ) {
		...
		$text_editor = json_decode( $this->get_params( 'text_editor' ) );
		$meta        = array(
	...
	private function social_icons_html( $icons_text ) {
		...
		$html             .= '<span class="' . $this->set( 'edit-item-shortcut' ) . ' wtyp_icons-edit" data-edit_section="social_icons">' . __( 'Edit', 'woo-thank-you-page-customizer' ) . '</span><ul class="wtyp-list-socials wtyp-list-unstyled" id="wtyp-sharing-accounts">';
		ob_start();
		?>
        ...
        <div class="<?php echo $this->set( array( 'thank_you_message__container', 'item__container' ) ) ?>"
             id="<?php echo $this->set( 'thank_you_message__container' ) ?>">
                ...
                <span class="<?php echo $this->set( 'edit-item-shortcut' ) ?> wtyp_icons-edit"
                      data-edit_section="thank_you_message"><?php echo __( 'Edit', 'woo-thank-you-page-customizer' ) ?></span>
	...
	private function coupon_html( $order ) {
        ...
        <div class="<?php echo $this->set( array( 'coupon__container', 'item__container' ) ) ?>"
             id="<?php echo $this->set( 'coupon__container' ) ?>">
                ...
                <span class="<?php echo $this->set( 'edit-item-shortcut' ) ?> wtyp_icons-edit"
                      data-edit_section="coupon"><?php echo __( 'Edit', 'woo-thank-you-page-customizer' ) ?></span>
            <div class="<?php echo $this->set( array(
				'coupon__message',
				'coupon__detail',
			) ) ?>">
                        ...
                        <input type="text" readonly class="<?php echo $this->set( 'coupon__code-code' ); ?>"
                            ...
                            <span class="<?php echo $this->set( 'coupon__code-email' ); ?> <?php echo $this->get_params( 'coupon_email_enable' ) ? '' : 'woocommerce-thank-you-page-hidden' ?>">
                                <span class="<?php echo $this->set( 'coupon__code-mail-me' ); ?> wtyp_icons-opened-email-envelope"
                                      title="<?php echo __( 'Email me', 'woo-thank-you-page-customizer' ) ?>"></span>
                                <span class="<?php echo $this->set( 'coupon__code-copy-code' ); ?> wtyp_icons-copy"
                                      title="<?php echo __( 'Copy code', 'woo-thank-you-page-customizer' ) ?>"></span>
                            </span>
	...
	private function google_map_html( $order, $google_map_address ) {
        ...
        <div class="<?php echo $this->set( array( 'google_map__container', 'item__container' ) ) ?>"
             id="<?php echo $this->set( 'google_map__container' ) ?>">
                    <span class="<?php echo $this->set( 'edit-item-shortcut' ) ?> wtyp_icons-edit"
                          data-edit_section="google_map"><?php echo __( 'Edit', 'woo-thank-you-page-customizer' ) ?></span>
	...
	private function text_editor_html( $order ) {
		...
		if ( is_array( $this->text_editor ) && count( $this->text_editor ) ) {
            ...
            <div class="<?php echo $this->set( array( 'text-editor', 'item__container' ) ) ?>"
                ...
                <span class="<?php echo $this->set( 'text-editor-edit' ) ?> wtyp_icons-edit"><?php esc_html_e( 'Edit', 'woo-thank-you-page-customizer' ) ?></span>
	...
	private function customer_information_html( $order, $customer_information_header ) {
        ...
        <div class="<?php echo $this->set( array( 'customer_information__container', 'item__container' ) ) ?>"
             id="<?php echo $this->set( 'customer_information__container' ) ?>">
                ...
                <span class="<?php echo $this->set( 'edit-item-shortcut' ) ?> wtyp_icons-edit"
                      data-edit_section="customer_information"><?php echo __( 'Edit', 'woo-thank-you-page-customizer' ) ?></span>
            ...
            <div class="<?php echo $this->set( array(
                ...
                <div class="<?php echo $this->set( 'customer_information-header' ) ?>">
                    <div><?php echo trim( strtolower( $customer_information_header ) ) === 'customer information' ? __( 'Customer information', 'woo-thank-you-page-customizer' ) : wp_kses_post( nl2br( $customer_information_header ) ); ?></div>
                </div>
            </div>
            <div class="<?php echo $this->set( array(
	...
	private function order_details_html( $order, $order_details_header, $order_details_product_image, $order_details_product_quantity_in_image ) {
        ...
        <div class="<?php echo $this->set( array( 'order_details__container', 'item__container' ) ) ?>"
             id="<?php echo $this->set( 'order_details__container' ) ?>">
                ...
                <span class="<?php echo $this->set( 'edit-item-shortcut' ) ?> wtyp_icons-edit"
                      data-edit_section="order_details"><?php echo __( 'Edit', 'woo-thank-you-page-customizer' ) ?></span>
            ...
            <div class="<?php echo $this->set( array(
                ...
                <div class="<?php echo $this->set( array(
                    ...
                    <div><?php echo trim( strtolower( $order_details_header ) ) === 'order details' ? __( 'Order details', 'woo-thank-you-page-customizer' ) : wp_kses_post( nl2br( $order_details_header ) ); ?></div>
                </div>
            </div>
            ...
            <div class="<?php echo $this->set( array(
                ...
                <div class="<?php echo $this->set( array(
                    ...
                    <div><?php _e( 'Product', 'woo-thank-you-page-customizer' ); ?></div>
                </div>
                <div class="<?php echo $this->set( array(
					'order_details__header-value',
					'order_details-value'
				) ) ?>">
                    <div><?php _e( 'Total', 'woo-thank-you-page-customizer' ); ?></div>
                </div>
            </div>
            <div class="<?php echo $this->set( array(
			...
			if ( $order->get_customer_note() ) {
                ...
                <div class="<?php echo $this->set( array(
                    ...
                    <div class="<?php echo $this->set( array(
                        ...
                        <div><?php _e( 'Note', 'woocommerce' ); ?></div>
                    </div>
                    <div class="<?php echo $this->set( array(
						'order_details-value'
					) ) ?>">
	...
	private function order_confirmation_html( $order, $order_confirmation_header ) {
        ...
        <div class="<?php echo $this->set( array( 'order_confirmation__container', 'item__container' ) ) ?>"
             id="<?php echo $this->set( 'order_confirmation__container' ) ?>">
                ...
                <span class="<?php echo $this->set( 'edit-item-shortcut' ) ?> wtyp_icons-edit"
                      data-edit_section="order_confirmation"><?php echo __( 'Edit', 'woo-thank-you-page-customizer' ) ?></span>
            ...
            <div class="<?php echo $this->set( array(
                ...
                <div class="<?php echo $this->set( array(
                    ...
                    <div><?php echo trim( strtolower( $order_confirmation_header ) ) === 'order confirmation' ? __( 'Order confirmation', 'woo-thank-you-page-customizer' ) : wp_kses_post( nl2br( $order_confirmation_header ) ); ?></div>
                </div>
            </div>
            <div class="<?php echo $this->set( array(
                ...
                <div class="<?php echo $this->set( array(
                    ...
                    <div><?php _e( 'Order number', 'woo-thank-you-page-customizer' ); ?></div>
                </div>
                <div class="<?php echo $this->set( array(
            ...
            <div class="<?php echo $this->set( array(
                ...
                <div class="<?php echo $this->set( array(
                    ...
                    <div><?php _e( 'Date', 'woo-thank-you-page-customizer' ); ?></div>
                </div>
                <div class="<?php echo $this->set( array(
			...
			<?php if ( is_user_logged_in() && $order->get_user_id() === get_current_user_id() && $order->get_billing_email() ) { ?>
                <div class="<?php echo $this->set( array(
                    ...
                    <div class="<?php echo $this->set( array(
                        ...
                        <div><?php _e( 'Email', 'woo-thank-you-page-customizer' ); ?></div>
                    </div>
                    <div class="<?php echo $this->set( array(
			...
			<?php if ( $order->get_payment_method_title() ) { ?>
                <div class="<?php echo $this->set( array(
                    ...
                    <div class="<?php echo $this->set( array(
                        ...
                        <div><?php _e( 'Payment method', 'woo-thank-you-page-customizer' ); ?></div>
                    </div>
                    <div class="<?php echo $this->set( array(
