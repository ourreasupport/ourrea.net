											...
											<td>
												<?php
													...
													if( in_array( $v['name'], $notAvailableForAdminSection ) ){
														...
														?>
														<input type="checkbox" onClick="checkAndH(this, '#uap-field-display-admin<?php echo $k;?>');inc_req(this, <?php echo $k;?>);" <?php if($v['display_admin']) echo 'checked';?> />
											...
											<td>
												<?php
													if ($v['display_public_reg']==2){
														...
														?>
														<input type="checkbox" onClick="checkAndH(this, '#uap-field-display-public-reg<?php echo $k;?>');inc_req(this, <?php echo $k;?>);" <?php if($v['display_public_reg']) echo 'checked';?> />
											...
											<td>
												<?php
													if ($v['display_public_ap']==2){
														...
														?>
														<input type="checkbox" onClick="checkAndH(this, '#uap-field-display-public-ap<?php echo $k;?>');inc_req(this, <?php echo $k;?>);" <?php if($v['display_public_ap']) echo 'checked';?> />
											...
											<td>
												<?php
													if ($v['display_public_reg']==2){
														...
														?>
														<input type="checkbox" onClick="checkAndH(this, '#uap-require-<?php echo $k;?>');" <?php if ($v['req']) echo 'checked';?> id="req-check-<?php echo $k;?>" />
