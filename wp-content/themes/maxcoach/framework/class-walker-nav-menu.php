...
class Maxcoach_Walker_Nav_Menu extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( 'ic_mega_menu' === $item->object ) {
			...
			$output .= '<div class="' . esc_attr( $mega_menu_content_class ) . '"><div class="container"><div class="row"><div class="col-xs-12">' . do_shortcode( '[elementor-template id="' . $item->object_id . '"]' ) . '</div></div></div></div>';
		} else {
