<div class="uap-ap-wrap">
  ...
  <div>
	...
	<div class="uap-profile-box-wrapper">
    	<div class="uap-profile-box-title"><span><?php _e('Temporary Hide Info Affiliate Bar', 'uap');?></span></div>
        <div class="uap-profile-box-content">
        	<div class="uap-row ">
            	<div class="uap-col-xs-12">
                <div><?php _e('If is necessary you may turn off Info Affiliate Bar for 24hrs and will show up automatically after this period.', 'uap');?></div>
                </div>
            </div>
            <div class="uap-row ">
            	<div class="uap-col-xs-4">    
      ...
      <div>
        <input type="submit" name="save" value="<?php _e("Save Changes", 'uap');?>"  />
      </div>
    </form>
