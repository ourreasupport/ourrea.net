...
$text_editor = json_decode( $data->get_params( 'text_editor' ) );
...
//                                                                                }
																			...
																			if ( $order_details_product_image && $product_image_src ) {
																				echo apply_filters( 'woo_thank_you_page_order_item_image', $product_permalink ? sprintf( '<div><a href="%s" class="%s"><img class="%s" src="%s" alt="%s">%s</a></div>', $product_permalink, $data->set( 'order-item-image-wrap' ), $data->set( 'order-item-image' ), $product_image_src, $alt ? $alt : $item->get_name(), $order_details_product_quantity_in_image ? apply_filters( 'woocommerce_order_item_quantity_html', $product_quantity_html, $item ) : '' ) : $item->get_name(), $item, $is_visible );
																			}
																			?>
                                                                            <div>
																				<?php
