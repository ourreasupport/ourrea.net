...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.header-12 .menu--primary > ul > li > a',
		),
	),
) );
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'   => array(
		array(
			'element' => '.header-12.header-dark .page-header-inner',
		),
	),
) );
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'choice'   => 'hover',
			'element'  => '.header-12.header-dark .header-icon:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.header-12.header-dark .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
		),
	),
) );
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-12.header-dark .mini-cart .mini-cart-icon:after',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-12.header-dark .menu--primary > ul > li > a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '12', 'dark', false ),
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'default'         => array(
		'color'      => Maxcoach::SECONDARY_COLOR,
		'background' => '#fff',
		'border'     => Maxcoach::PRIMARY_COLOR,
	),
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '12', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '12', 'dark', false ),
	'active_callback' => array(
		array(
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '12', 'dark', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'dark_button_color',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'    => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-12.header-dark .header-social-networks a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.header-12.header-dark .header-social-networks a:hover',
			'property' => 'color',
		),
	),
) );
...
Maxcoach_Kirki::add_field( 'theme', array(
	'type'     => 'background',
	'settings' => $prefix . 'light_background',
	'label'    => esc_html__( 'Background', 'maxcoach' ),
	'section'  => $section,
	'priority' => $priority++,
	'default'  => array(
	...
	'output'   => array(
		array(
			'element' => '.header-12.header-light .page-header-inner',
		),
	),
) );
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		...
		array(
			'choice'   => 'hover',
			'element'  => '.header-12.header-light .header-icon:hover',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.header-12.header-light .wpml-ls-slot-shortcode_actions:hover > .js-wpml-ls-item-toggle',
			'property' => 'color',
		),
	),
) );
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'color',
			'element'  => '.header-12.header-light .mini-cart .mini-cart-icon:after',
			'property' => 'color',
		),
		array(
			'choice'   => 'background',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-12.header-light .menu--primary > ul > li > a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '12', 'light', false ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_search_form_kirki_output( '12', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'search_enable',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '12', 'light', false ),
	'active_callback' => array(
		array(
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'          => Maxcoach_Header::instance()->get_button_kirki_output( '12', 'light', true ),
	'active_callback' => array(
		array(
			'setting'  => $prefix . 'light_button_color',
			'operator' => '==',
...
Maxcoach_Kirki::add_field( 'theme', array(
	...
	'output'    => array(
		array(
			'choice'   => 'normal',
			'element'  => '.header-12.header-light .header-social-networks a',
			'property' => 'color',
		),
		array(
			'choice'   => 'hover',
			'element'  => '.header-12.header-light .header-social-networks a:hover',
			'property' => 'color',
		),
	),
) );
