(
	function( $ ) {
		...
		var MaxcoachTypedHeadlineHandler = function( $scope, $ ) {
		...
		$( window ).on( 'elementor/frontend/init', function() {
			elementorFrontend.hooks.addAction( 'frontend/element_ready/tm-typed-headline.default', MaxcoachTypedHeadlineHandler );
		} );
	}
)( jQuery );
