...
class Widget_Image_Layers extends Base {
	...
	public function get_title() {
		return esc_html__( 'Image Layers', 'maxcoach' );
	}
	...
	private function add_artboard_section() {
		$this->start_controls_section( 'artboard_section', [
			'label' => esc_html__( 'Artboard', 'maxcoach' ),
		] );
	...
	private function add_layers_section() {
		$this->start_controls_section( 'layers_section', [
			'label' => esc_html__( 'Layers', 'maxcoach' ),
		] );

		$repeater = new Repeater();

		$repeater->add_control( 'static', [
			'label' => esc_html__( 'Static Layer', 'maxcoach' ),
		...
		$repeater->start_controls_tab( 'layer_loop_tab', [
			'label' => esc_html__( 'Loop', 'maxcoach' ),
		] );
		...
		$repeater->add_control( 'loop', [
			...
			'options' => [
				...
				'rotate'          => esc_html__( 'Rotate', 'maxcoach' ),
				'move-horizontal' => esc_html__( 'Move - Horizontal', 'maxcoach' ),
				'move-vertical'   => esc_html__( 'Move - Vertical', 'maxcoach' ),
			],
			'default' => '',
		] );
