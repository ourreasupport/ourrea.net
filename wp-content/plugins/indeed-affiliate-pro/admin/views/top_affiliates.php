					...
					<div class="uap-column column-one">
						...
						<div class="uap-settings-inner">
							<div class="uap-user-list-row">
								...
								<div class="uap-field"><input type="number" value="<?php echo $meta_arr['num_of_entries'];?>" id="num_of_entries" onKeyUp="uapPreviewUList();" onChange="uapPreviewUList();" style="width: 81px;" min="0" /></div>
							</div>
							<div class="uap-user-list-row">
								<div class="uap-label"><?php _e("Entries Per Page:", 'uap');?></div>
								<div class="uap-field"><input type="number" value="<?php echo $meta_arr['entries_per_page'];?>" id="entries_per_page" onKeyUp="uapPreviewUList();" onChange="uapPreviewUList();" style="width: 81px;" min="1" /></div>
							</div>
					...
					<div class="uap-column column-three">
						...
						<div class="uap-settings-inner">
		                            ...
		                            <ul id="colors_ul" class="colors_ul">
		                                <?php
		                                    ...
		                                    foreach ($color_scheme as $color){
		                                        ...
		                                        ?>
		                                            <li class="<?php echo $class;?>" onClick="uapChangeColorScheme(this, '<?php echo $color;?>', '#color_scheme');uapPreviewUList();" style="background-color: #<?php echo $color;?>;"></li>
		                                        <?php
		                                        $i++;
		                                    }
		                                ?>
							...
							<div class="uap-user-list-row">
								...
								<input type="checkbox" id="align_center" <?php echo $checked;?> onClick="uapPreviewUList();"/> <?php _e("Align the Items Centered", 'uap');?>
							</div>

							<div class="uap-user-list-row">
								<?php $checked = ($meta_arr['include_fields_label']) ? 'checked' : '';?>
								<input type="checkbox" class="" id="include_fields_label" onClick="uapPreviewUList();" <?php echo $checked;?> />
					...
					<div class="uap-column column-four" style="width:50%;">
						...
						<div class="uap-settings-inner">
							<div class="uap-user-list-row">
								...
								<input type="checkbox" <?php echo $checked;?> id="slider_set" onClick="uapCheckboxDivRelation(this, '#slider_options');uapPreviewUList();"/> <b><?php echo __('Show as Slider', 'uap');?></b>
							...
							<div style="opacity:0.5" id="slider_options" >
						     ...
						     <div class="splt-1">
								<div class="uap-user-list-row">
									...
									<div class="uap-field">
										<input type="number" min="1" id="items_per_slide" onChange="uapPreviewUList();" onKeyup="uapPreviewUList();" value="<?php echo $meta_arr['items_per_slide'];?>" class=""/>
									</div>
								</div>
								<div class="uap-user-list-row">
									<div class="uap-label"><?php _e('Slider Timeout:', 'uap');?></div>
									<div class="uap-field">
										<input type="number" min="1" id="speed" onChange="uapPreviewUList();" onKeyup="uapPreviewUList();" value="<?php echo $meta_arr['speed'];?>" class=""/>
									</div>
								</div>
								<div class="uap-user-list-row">
									<div class="uap-label"><?php _e('Pagination Speed:', 'uap');?></div>
									<div class="uap-field">
										<input type="number" min="1" id="pagination_speed" onChange="uapPreviewUList();" onKeyup="uapPreviewUList();" value="<?php echo $meta_arr['pagination_speed'];?>" class=""/>
									</div>
								</div>
								 <div class="uap-user-list-row">
	                          		<div class="uap-label"><?php _e('Pagination Theme:', 'uap');?></div>
	                          		<div class="uap-field">
		                          		<select id="pagination_theme" onChange="uapPreviewUList();" style="min-width:162px;"><?php
		                          			$array = array(
	                            ...
	                            <div class="uap-user-list-row">
	                          		...
	                          		<div class="uap-field">
	                                  <select onChange="uapPreviewUList();" id="animation_in" style="min-width:162px;">
	                          ...
	                          <div class="uap-user-list-row">
	                          		...
	                          		<div class="uap-field">
	                                    <select onChange="uapPreviewUList();" id="animation_out" style="min-width:162px;">
										  <option value="none">None</option>
							...
							<div class="splt-2">
								...
								<div class="uap-user-list-row">
									...
									<input type="checkbox" id="bullets" onClick="uapPreviewUList();" <?php echo $checked;?> /> <?php _e("Bullets", 'uap');?>
								</div>
								<div class="uap-user-list-row">
									<?php $checked = (empty($meta_arr['nav_button'])) ? '' : 'checked';?>
									<input type="checkbox" id="nav_button" onClick="uapPreviewUList();" <?php echo $checked;?> /> <?php _e("Nav Button", 'uap');?>
								</div>
								<div class="uap-user-list-row">
									<?php $checked = (empty($meta_arr['autoplay'])) ? '' : 'checked';?>
									<input type="checkbox" id="autoplay" onClick="uapPreviewUList();" <?php echo $checked;?> /> <?php _e("AutoPlay", 'uap');?>
								</div>
								<div class="uap-user-list-row">
									<?php $checked = (empty($meta_arr['stop_hover'])) ? '' : 'checked';?>
									<input type="checkbox" id="stop_hover" onClick="uapPreviewUList();" <?php echo $checked;?> /> <?php _e("Stop On Hover", 'uap');?>
								</div>
								<div class="uap-user-list-row">
									<?php $checked = (empty($meta_arr['responsive'])) ? '' : 'checked';?>
									<input type="checkbox" id="responsive" onClick="uapPreviewUList();" <?php echo $checked;?> /> <?php _e("Responsive", 'uap');?>
								</div>
								<div class="uap-user-list-row">
									<?php $checked = (empty($meta_arr['autoheight'])) ? '' : 'checked';?>
									<input type="checkbox" id="autoheight" onClick="uapPreviewUList();" <?php echo $checked;?> /> <?php _e("Auto Height", 'uap');?>
								</div>
								<div class="uap-user-list-row">
									<?php $checked = (empty($meta_arr['lazy_load'])) ? '' : 'checked';?>
									<input type="checkbox" id="lazy_load" onClick="uapPreviewUList();" <?php echo $checked;?> /> <?php _e("Lazy Load", 'uap');?>
								</div>
								<div class="uap-user-list-row">
									<?php $checked = (empty($meta_arr['loop'])) ? '' : 'checked';?>
									<input type="checkbox" id="loop" onClick="uapPreviewUList();" <?php echo $checked;?> /> <?php _e("Play in Loop", 'uap');?>
								</div>
							</div>
									...
									foreach ($reg_fields as $k=>$v){
				  					...
				  					foreach ($fields_arr as $k=>$v){
				  						...
				  						<div class="uap-memberslist-fields" style="color: <?php echo $color;?>;">
				  							<input type="checkbox" <?php echo $checked;?> value="<?php echo $k;?>" onClick="uapMakeInputhString(this, '<?php echo $k;?>', '#user_fields');uapPreviewUList();" /> <?php echo $v;?>
				  						</div>
				  						<?php
				  					}
				  				?>
