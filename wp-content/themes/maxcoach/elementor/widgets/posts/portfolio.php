...
class Widget_Portfolio extends Posts_Base {
	...
	public function get_title() {
		return esc_html__( 'Portfolio', 'maxcoach' );
	}
	...
	private function add_layout_section() {
		...
		$this->add_control( 'overlay_style', [
			...
			'options' => [
				''              => esc_html__( 'None', 'maxcoach' ),
				'faded'         => esc_html__( 'Faded 01', 'maxcoach' ),
				'faded-02'      => esc_html__( 'Faded 02', 'maxcoach' ),
				'faded-04'      => esc_html__( 'Faded 04', 'maxcoach' ),
				'colored-faded' => esc_html__( 'Colored Faded', 'maxcoach' ),
				'movement'      => esc_html__( 'Movement', 'maxcoach' ),
				'flat'          => esc_html__( 'Flat', 'maxcoach' ),
				'float'         => esc_html__( 'Float', 'maxcoach' ),
				'huge'          => esc_html__( 'Huge', 'maxcoach' ),
			],
			'default' => '',
		] );
		...
		$this->add_control( 'overlay_colored_faded_info', [
			...
			'raw'             => esc_html__( 'To choose overlay color & skin for each post item then please edit them & go to Page Options box & select Portfolio tab.', 'maxcoach' ),
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', [
			'maxcoach-grid-wrapper tm-portfolio',
		...
		<div <?php $this->print_attributes_string( 'wrapper' ); ?>>
			<?php if ( $query->have_posts() ) : ?>
				...
				?>
				<input type="hidden" class="maxcoach-query-input" <?php echo 'value="' . $maxcoach_grid_query . '"'; ?>/>
