...
var data_url=$canvas.toDataURL();var imageBlob=dataURItoBlob(data_url);var ajaxData=new FormData();ajaxData.append('files',imageBlob,options.name);downloadjs($canvas.toDataURL(args),options.name);return false;}
