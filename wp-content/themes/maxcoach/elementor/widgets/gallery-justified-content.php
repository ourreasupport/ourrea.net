...
class Widget_Gallery_Justified_Content extends Base {
	...
	public function get_title() {
		return esc_html__( 'Gallery Justified Content', 'maxcoach' );
	}
	...
	public function get_script_depends() {
		return [ 'maxcoach-widget-gallery-justified-content' ];
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'maxcoach-gallery-justified-content' );
		?>
