var UapPasswordStrength={colors:['#F00','#F90','#FF0','#9F0','#0F0'],labels:[],init:function(args){var obj=this;obj.setAttributes(obj,args);obj.labels=jQuery.parseJSON(window.uapPasswordStrengthLabels);jQuery(document).ready(function(){jQuery(document).on('keyup',jQuery('[name=pass1]'),function(evt){obj.handleTypePassword(obj,evt);})
