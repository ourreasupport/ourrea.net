...
class Widget_Heading extends Base {
	...
	public function get_title() {
		return esc_html__( 'Modern Heading', 'maxcoach' );
	}
	...
	private function add_title_section() {
		$this->start_controls_section( 'title_section', [
			'label' => esc_html__( 'Heading', 'maxcoach' ),
		] );
		...
		$this->add_control( 'title', [
			...
			'description' => esc_html__( 'Wrap any words with &lt;mark&gt;&lt;/mark&gt; tag to make them highlight.', 'maxcoach' ),
		] );
		...
		$this->add_control( 'title_link_animate', [
			'label'        => esc_html__( 'Link Animate', 'maxcoach' ),
			'type'         => Controls_Manager::SELECT,
			'options'      => [
				''                  => esc_html__( 'None', 'maxcoach' ),
				'animate-border'    => esc_html__( 'Animate Border', 'maxcoach' ),
				'animate-border-02' => esc_html__( 'Animate Border 02', 'maxcoach' ),
			],
			'default'      => '',
			'prefix_class' => 'maxcoach-link-',
		] );
		...
		$this->add_control( 'divider_enable', [
			'label' => esc_html__( 'Display Divider', 'maxcoach' ),
	...
	private function add_sub_title_section() {
		$this->start_controls_section( 'sub_title_section', [
			'label' => esc_html__( 'Secondary Heading', 'maxcoach' ),
		] );
	...
	private function add_title_style_section() {
		...
		$this->add_control( 'highlight_heading', [
			'label'     => esc_html__( 'Highlight Words', 'maxcoach' ),
	...
	private function add_divider_style_section() {
		$this->start_controls_section( 'divider_style_section', [
			'label'     => esc_html__( 'Divider', 'maxcoach' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'divider_enable' => 'yes',
			],
