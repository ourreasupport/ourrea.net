							...
							<?php foreach ($data['rank_list'] as $id=>$label) :?>
									<div class="input-group" style="margin-bottom:20px;">
										<span class="input-group-addon" id="basic-addon1"><?php echo $label;?></span>
									 		<input type="number" class="form-control" min="0" step='<?php echo uapInputNumerStep();?>' class="uap-input-number" value="<?php echo $data['rank_value_array'][$id];?>" name="<?php echo "pay_per_click_value[$id]";?>" />
