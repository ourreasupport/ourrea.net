...
class VI_WOO_THANK_YOU_PAGE_Admin_Design {
	...
	protected function add_section_design_general( $wp_customize ) {
		$wp_customize->add_section( 'woo_thank_you_page_design_general', array(
			...
			'theme_supports' => '',
			'title'          => __( 'WooCommerce Thank You Page', 'woo-thank-you-page-customizer' ),
		) );
		$default_order_id = '';
		$args             = array(
		...
		if ( $this->get_params( 'select_order' ) ) {
			$select_orders[ $this->get_params( 'select_order' ) ] = sprintf( __( 'Order #%s', 'woo-thank-you-page-customizer' ), $this->get_params( 'select_order' ) );
		}
		if ( $the_query->have_posts() ) {
			while ( $the_query->have_posts() ) {
				...
				$select_orders[ $order_id ] = sprintf( __( 'Order #%s', 'woo-thank-you-page-customizer' ), $order_id );
			}
		} else {
			wp_reset_postdata();
			$args      = array(
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[select_order]', array(
			...
			'label'    => __( 'Select order to preview', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[custom_css]', array(
			...
			'priority' => 10,
			'section'  => 'woo_thank_you_page_design_general',
			'label'    => __( 'Custom CSS', 'woo-thank-you-page-customizer' )
		) );
	}
	...
	protected function add_section_design_order_confirmation( $wp_customize ) {
		...
		$wp_customize->add_section( 'woo_thank_you_page_design_order_confirmation', array(
			...
			'capability'     => 'manage_options',
			'theme_supports' => '',
			'title'          => __( 'Order Confirmation', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Background Color', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_padding]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_order_confirmation',
			'label'       => __( 'Padding(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_border_radius]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_order_confirmation',
			'label'       => __( 'Rounded Corner(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_border_width]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_order_confirmation',
			'label'       => __( 'Border Width(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_border_style]', array(
			...
			'label'   => __( 'Border Style', 'woo-thank-you-page-customizer' ),
			'choices' => array(
				'solid'  => __( 'Solid', 'woo-thank-you-page-customizer' ),
				'dotted' => __( 'Dotted', 'woo-thank-you-page-customizer' ),
				'dashed' => __( 'Dashed', 'woo-thank-you-page-customizer' ),
			),
		) );
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Border Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_order_confirmation',
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_vertical_width]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_order_confirmation',
			'label'       => __( 'Vertical Separator Width(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_vertical_style]', array(
			'type'    => 'select',
			'section' => 'woo_thank_you_page_design_order_confirmation', // Add a default or your own section
			'label'   => __( 'Vertical Separator Style', 'woo-thank-you-page-customizer' ),
			'choices' => array(
				'solid'  => __( 'Solid', 'woo-thank-you-page-customizer' ),
				'dotted' => __( 'Dotted', 'woo-thank-you-page-customizer' ),
				'dashed' => __( 'Dashed', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Vertical Separator Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_order_confirmation',
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_horizontal_width]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_order_confirmation',
			'label'       => __( 'Horizontal Separator Width(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_horizontal_style]', array(
			'type'    => 'select',
			'section' => 'woo_thank_you_page_design_order_confirmation', // Add a default or your own section
			'label'   => __( 'Horizontal Separator Style', 'woo-thank-you-page-customizer' ),
			'choices' => array(
				'solid'  => __( 'Solid', 'woo-thank-you-page-customizer' ),
				'dotted' => __( 'Dotted', 'woo-thank-you-page-customizer' ),
				'dashed' => __( 'Dashed', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Horizontal Separator Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_order_confirmation',
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_header]', array(
			'type'        => 'textarea',
			'section'     => 'woo_thank_you_page_design_order_confirmation',
			'label'       => __( 'Header Text', 'woo-thank-you-page-customizer' ),
			'description' => __( '<span class="' . $this->set( 'available-shortcodes-shortcut' ) . '">Shortcodes list</span>', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_header_font_size]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_order_confirmation',
			'label'       => __( 'Header Font Size(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_header_text_align]', array(
			'type'    => 'select',
			'section' => 'woo_thank_you_page_design_order_confirmation', // Add a default or your own section
			'label'   => __( 'Header Text Align', 'woo-thank-you-page-customizer' ),
			'choices' => array(
				'left'    => __( 'Left', 'woo-thank-you-page-customizer' ),
				'center'  => __( 'Center', 'woo-thank-you-page-customizer' ),
				'right'   => __( 'Right', 'woo-thank-you-page-customizer' ),
				'justify' => __( 'Justify', 'woo-thank-you-page-customizer' ),
			),
		) );
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Header Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_order_confirmation',
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Header Background Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_order_confirmation',
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_title_font_size]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_order_confirmation',
			'label'       => __( 'Title Font Size(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_title_text_align]', array(
			'type'    => 'select',
			'section' => 'woo_thank_you_page_design_order_confirmation', // Add a default or your own section
			'label'   => __( 'Title Text Align', 'woo-thank-you-page-customizer' ),
			'choices' => array(
				'left'    => __( 'Left', 'woo-thank-you-page-customizer' ),
				'center'  => __( 'Center', 'woo-thank-you-page-customizer' ),
				'right'   => __( 'Right', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Title Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_order_confirmation',
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Title Background Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_order_confirmation',
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_value_font_size]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_order_confirmation',
			'label'       => __( 'Value Font Size(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_confirmation_value_text_align]', array(
			'type'    => 'select',
			'section' => 'woo_thank_you_page_design_order_confirmation', // Add a default or your own section
			'label'   => __( 'Value Text Align', 'woo-thank-you-page-customizer' ),
			'choices' => array(
				'left'    => __( 'Left', 'woo-thank-you-page-customizer' ),
				'center'  => __( 'Center', 'woo-thank-you-page-customizer' ),
				'right'   => __( 'Right', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Value Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_order_confirmation',
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Value Background Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_order_confirmation',
	...
	protected function add_section_design_thank_you_message( $wp_customize ) {
		...
		$wp_customize->add_section( 'woo_thank_you_page_design_thank_you_message', array(
			...
			'capability'     => 'manage_options',
			'theme_supports' => '',
			'title'          => __( 'Thank You Message', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Color', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[thank_you_message_text_align]', array(
			...
			'label'   => __( 'Text Align', 'woo-thank-you-page-customizer' ),
			'choices' => array(
				'left'    => __( 'Left', 'woo-thank-you-page-customizer' ),
				'center'  => __( 'Center', 'woo-thank-you-page-customizer' ),
				'right'   => __( 'Right', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[thank_you_message_message]', array(
			'type'        => 'textarea',
			'section'     => 'woo_thank_you_page_design_thank_you_message',
			'label'       => __( 'Message Text', 'woo-thank-you-page-customizer' ),
			'description' => __( '<span class="' . $this->set( 'available-shortcodes-shortcut' ) . '">Shortcodes list</span>', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[thank_you_message_message_font_size]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_thank_you_message',
			'label'       => __( 'Message Font Size(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
	...
	protected function add_section_design_coupon( $wp_customize ) {
		...
		$wp_customize->add_section( 'woo_thank_you_page_design_coupon', array(
			...
			'capability'     => 'manage_options',
			'theme_supports' => '',
			'title'          => __( 'Coupon', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[coupon_message]', array(
			...
			'section'     => 'woo_thank_you_page_design_coupon',
			'label'       => __( 'Message Text', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Available shortcode: {coupon_amount}, {coupon_date_expires}, {last_valid_date}, {coupon_code}<p><span class="' . $this->set( 'available-shortcodes-shortcut' ) . '">Shortcodes list</span></p>', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Coupon Code Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_coupon',
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Coupon Code Background Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_coupon',
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Scissors color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_coupon',
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[coupon_email_enable]', array(
			'type'        => 'checkbox',
			'section'     => 'woo_thank_you_page_design_coupon',
			'label'       => __( 'Show button to handle coupon code', 'woo-thank-you-page-customizer' ),
			'description' => __( 'If enabled, when hovering the coupon field, 2 buttons will show to copy coupon code or send code to billing email.', 'woo-thank-you-page-customizer' ),
		) );
	...
	protected function add_section_design_order_details( $wp_customize ) {
		...
		$wp_customize->add_section( 'woo_thank_you_page_design_order_details', array(
			...
			'capability'     => 'manage_options',
			'theme_supports' => '',
			'title'          => __( 'Order Details', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Text Color', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_details_product_image]', array(
			'type'    => 'checkbox',
			'section' => 'woo_thank_you_page_design_order_details', // Add a default or your own section
			'label'   => __( 'Display Product Image', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[order_details_product_image_width]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_order_details',
			'label'       => __( 'Product Image width(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
	...
	protected function add_section_design_customer_information( $wp_customize ) {
		...
		$wp_customize->add_section( 'woo_thank_you_page_design_customer_information', array(
			...
			'capability'     => 'manage_options',
			'theme_supports' => '',
			'title'          => __( 'Customer Information', 'woo-thank-you-page-customizer' ),
...
//		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[customer_information_address_font_size]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_customer_information',
			'label'       => __( 'Address Font Size(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[customer_information_address_text_align]', array(
			'type'    => 'select',
			'section' => 'woo_thank_you_page_design_customer_information', // Add a default or your own section
			'label'   => __( 'Address Text Align', 'woo-thank-you-page-customizer' ),
			'choices' => array(
				'left'    => __( 'Left', 'woo-thank-you-page-customizer' ),
				'center'  => __( 'Center', 'woo-thank-you-page-customizer' ),
				'right'   => __( 'Right', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Address Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_customer_information',
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'    => __( 'Address Background Color', 'woo-thank-you-page-customizer' ),
					'section'  => 'woo_thank_you_page_design_customer_information',
	...
	protected function add_section_design_social_icons( $wp_customize ) {
		...
		$wp_customize->add_section( 'woo_thank_you_page_design_social_icons', array(
			...
			'capability'     => 'manage_options',
			'theme_supports' => '',
			'title'          => __( 'Social Media', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_header]', array(
			...
			'label'       => __( 'Text Follow Social Network', 'woo-thank-you-page-customizer' ),
			'description' => __( '<span class="' . $this->set( 'available-shortcodes-shortcut' ) . '">Shortcodes list</span>', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_size]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'Icons size (px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_align]', array(
			'type'    => 'select',
			'section' => 'woo_thank_you_page_design_social_icons',
			'label'   => __( 'Icons align', 'woo-thank-you-page-customizer' ),
			'choices' => array(
				'left'    => __( 'Left', 'woo-thank-you-page-customizer' ),
				'center'  => __( 'Center', 'woo-thank-you-page-customizer' ),
				'right'   => __( 'Right', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_space]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'Spaces Between Icons (px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_target]', array(
			'type'    => 'select',
			'section' => 'woo_thank_you_page_design_social_icons',
			'label'   => __( 'When click on social icons', 'woo-thank-you-page-customizer' ),
			'choices' => array(
				'_blank' => __( 'Open link in new tab', 'woo-thank-you-page-customizer' ),
				'_self'  => __( 'Open link in current tab', 'woo-thank-you-page-customizer' ),
			),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_facebook_url]', array(
			'type'        => 'url',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'Facebook URL', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Your Facebook URL Eg: https://www.facebook.com/villatheme', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'label'   => __( 'Icon Color', 'woo-thank-you-page-customizer' ),
					'section' => 'woo_thank_you_page_design_social_icons',
				) )
		);
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_twitter_url]', array(
			'type'        => 'url',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'Twitter URL', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Your Twitter URL Eg: https://www.twitter.com/villatheme', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_pinterest_url]', array(
			'type'        => 'url',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'Pinterest URL', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Your Pinterest URL', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_instagram_url]', array(
			'type'        => 'url',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'Instagram URL', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Your Instagram URL', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_dribbble_url]', array(
			'type'        => 'url',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'Dribbble URL', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Your Dribbble URL', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_tumblr_url]', array(
			'type'        => 'url',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'Tumblr URL', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Your Tumblr URL', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_google_url]', array(
			'type'        => 'url',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'Google Plus ID', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Your Google Plus URL', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_vkontakte_url]', array(
			'type'        => 'url',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'VKontakte URL', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Your VKontakte URL', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_linkedin_url]', array(
			'type'        => 'url',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'Linkedin URL', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Your Linkedin URL', 'woo-thank-you-page-customizer' ),
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[social_icons_youtube_url]', array(
			'type'        => 'url',
			'section'     => 'woo_thank_you_page_design_social_icons',
			'label'       => __( 'Youtube URL', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Your Youtube URL. Eg: https://www.youtube.com/channel/UCbCfnjbtBZIQfzLvXgNpbKw', 'woo-thank-you-page-customizer' ),
		) );
	...
	protected function add_section_design_google_map( $wp_customize ) {
		$wp_customize->add_section( 'woo_thank_you_page_design_google_map', array(
			...
			'capability'     => 'manage_options',
			'theme_supports' => '',
			'title'          => __( 'Google map', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[google_map_width]', array(
			...
			'label'       => __( 'Width(px)', 'woo-thank-you-page-customizer' ),
			'description' => __( 'If set 0, width will be 100%.', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[google_map_height]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_google_map',
			'label'       => __( 'Height(px)', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
		...
		$google_map_marker_choices['red-pushpin'] = array(
			'name'  => __( 'Red pushpin', 'woo-thank-you-page-customizer' ),
		...
		$google_map_marker_choices['default'] = array(
			...
			'name'  => __( 'Default', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control(
			new WOO_THANK_YOU_PAGE_CUSTOMIZER_Image_Radio_Button_Custom_Control(
				...
				array(
					'section' => 'woo_thank_you_page_design_google_map',
					'label'   => __( 'Marker', 'woo-thank-you-page-customizer' ),
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[google_map_address]', array(
			...
			'priority'    => 10,
			'section'     => 'woo_thank_you_page_design_google_map',
			'label'       => __( 'Address', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Can be either {billing_address}, {shipping_address}, {store_address} or a specific address. Click "Update map" after modifying address to apply changes to your preview map.<p><span class="wtyp-button-update-changes-google-map">Update map</span></p>', 'woo-thank-you-page-customizer' )
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[google_map_label]', array(
			...
			'priority'    => 10,
			'section'     => 'woo_thank_you_page_design_google_map',
			'label'       => __( 'Marker label', 'woo-thank-you-page-customizer' ),
			'description' => __( 'Use {address} to refer to the address that you enter above.', 'woo-thank-you-page-customizer' )
		) );
		...
		$wp_customize->add_control( 'woo_thank_you_page_params[google_map_zoom_level]', array(
			'type'        => 'number',
			'section'     => 'woo_thank_you_page_design_google_map',
			'label'       => __( 'Zoom level', 'woo-thank-you-page-customizer' ),
			'input_attrs' => array(
				'min'  => 0,
				'step' => 1
			),
