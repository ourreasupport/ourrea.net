					...
					<div class="uap-stuffbox">
						...
						<div class="inside">
						  ...
						  <?php _e('Login Template:', 'uap');?>
							<select name="uap_login_template" id="uap_login_template" onChange="uapLoginPreview();"  style="min-width:400px">
							<?php
				...
				<div class="uap-stuffbox">
					...
					<div class="inside">
							<div class="uap-form-line uap-no-border">
									<input type="checkbox" class="uap-checkbox" onClick="checkAndH(this, '#uap_login_remember_me');uapLoginPreview();" <?php if($data['metas']['uap_login_remember_me']==1) echo 'checked';?>/>
							...
							<div class="uap-form-line uap-no-border">
									<input type="checkbox" class="uap-checkbox" onClick="checkAndH(this, '#uap_login_register');uapLoginPreview();" <?php if($data['metas']['uap_login_register']==1) echo 'checked';?>/>
							...
							<div class="uap-form-line uap-no-border">
									<input type="checkbox" class="uap-checkbox" onClick="checkAndH(this, '#uap_login_pass_lost');uapLoginPreview();" <?php if($data['metas']['uap_login_pass_lost']==1) echo 'checked';?>/>
							...
							<div class="uap-form-line uap-no-border">
									<input type="checkbox" class="uap-checkbox" onClick="checkAndH(this, '#uap_login_show_recaptcha');uapLoginPreview();" <?php if($data['metas']['uap_login_show_recaptcha']==1) echo 'checked';?>/>
