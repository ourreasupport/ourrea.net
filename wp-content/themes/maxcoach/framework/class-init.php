...
class Maxcoach_Init {
	...
	public function initialize() {
		...
		if ( ! function_exists( '_wp_render_title_tag' ) ) {
			add_action( 'wp_head', array( $this, 'maxcoach_render_title' ) );
		}
	}

	function maxcoach_render_title() {
		?>
	...
	public function setup() {
		 ...
		 */
		load_theme_textdomain( 'maxcoach', MAXCOACH_THEME_DIR . '/languages' );
	...
	function core_info( $info ) {
		$info['icon']    = MAXCOACH_THEME_URI . '/assets/admin/images/logo.png';
		$info['tf']      = 'https://themeforest.net/item/maxcoach-online-courses-education-wp-theme/26051639';
		$info['docs']    = 'https://document.thememove.com/maxcoach';
		$info['child']   = 'https://api.thememove.com/update/maxcoach/maxcoach-child.zip';
		$info['update']  = 'https://api.thememove.com/update/maxcoach';
		$info['api']     = 'https://api.thememove.com/update/maxcoach';
		$info['support'] = 'https://thememove.ticksy.com/';
		$info['faqs']    = 'https://thememove.ticksy.com/articles/';
		$info['desc']    = esc_html__( 'Thank you for using our theme, please reward it a full five-star &#9733;&#9733;&#9733;&#9733;&#9733; rating.', 'maxcoach' );
