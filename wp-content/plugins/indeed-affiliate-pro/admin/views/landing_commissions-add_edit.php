<div class="uap-wrapper">
	...
	<h3 class="uap-h3"><?php _e('Landing Commission (CPA) Shortcode', 'uap');?><span class="uap-admin-need-help"><i class="fa-uap fa-help-uap"></i><a href="https://help.wpindeed.com/ultimate-affiliate-pro/knowledge-base/landing-commissions/" target="_blank"><?php _e('Need Help?', 'uap');?></a></span></h3>
	<div class="inside">
				...
				<div class="col-xs-6">
					...
					<p><?php _e('Based on the landing commission price, the referral amount will be calculated depending on each affiliate rank amount.', 'uap');?></p>
					 <div class="input-group">
						...
						<input type="number" step='<?php echo uapInputNumerStep();?>' min="0" style="max-width: 100px;"  step="0.01" class="form-control" name="amount_value" value="<?php echo $data['metas']['amount_value'];?>" aria-describedby="basic-addon1" /> <span style="padding: 7px; display:inline-block;"><?php echo $currency;?></span>
					 </div>
				 		</br>
