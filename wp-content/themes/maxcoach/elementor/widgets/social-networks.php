...
class Widget_Social_Networks extends Base {
	...
	public function get_title() {
		return esc_html__( 'Social Networks', 'maxcoach' );
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'style', [
			...
			'options' => [
				'icons'              => esc_html__( 'Icons', 'maxcoach' ),
				'large-icons'        => esc_html__( 'Large Icons', 'maxcoach' ),
				'flat-rounded-icon'  => esc_html__( 'Flat Rounded Icon', 'maxcoach' ),
				'solid-rounded-icon' => esc_html__( 'Solid Rounded Icon', 'maxcoach' ),
				'icon-title'         => esc_html__( 'Icon + Title', 'maxcoach' ),
		...
		$this->add_control( 'layout', [
			...
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'inline'      => esc_html__( 'Inline', 'maxcoach' ),
				'list'        => esc_html__( 'List', 'maxcoach' ),
				'two-columns' => esc_html__( '2 Columns', 'maxcoach' ),
			],
			'default' => 'inline',
		] );
		...
		$this->add_control( 'items', [
			...
			'default'     => [
				[
					'title' => esc_html__( 'Facebook', 'maxcoach' ),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
				...
				[
					'title' => esc_html__( 'Twitter', 'maxcoach' ),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
				...
				[
					'title' => esc_html__( 'Instagram', 'maxcoach' ),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
				...
				[
					'title' => esc_html__( 'Linkedin', 'maxcoach' ),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
	...
	private function add_style_section() {
		...
		$this->add_control( 'items_vertical_spacing', [
			'label'      => esc_html__( 'Items Vertical Spacing', 'maxcoach' ),
