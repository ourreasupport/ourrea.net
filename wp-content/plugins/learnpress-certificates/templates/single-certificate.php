...
<head>
    ...
    <meta property="og:title" content="<?php esc_attr_e( $cert->get_title() . ' &rsaquo; ' . $course->get_title() );?>"/>
	...
	<?php wp_print_styles( 'certificates' ); ?>
	<?php wp_print_styles( 'font-awesome' ); ?>
	<?php wp_print_scripts( 'certificates' ); ?>
